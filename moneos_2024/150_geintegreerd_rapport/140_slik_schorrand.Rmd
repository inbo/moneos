...
In de Beneden-Zeeschelde zijn enkele zones geïdentificeerd waar erosie en sedimentatie voorkomt in de laagste oeverzone.
De volgende zones zijn naar voren gehaald om nader te bekijken:

-   Doel -- erosieve zone (2022 - 2023) <!--# deze zone is gelegen binnen de zandwinningszone, zou ik niet rapporteren -->
-   Europaterminal -- sedimentatie (2022 - 2023) <!--# deze zone sedimenteert opnieuw op na eerdere bagger/verdieping voor of in 2020, zou ik niet rapporteren - nt relevant naar oever en slikbeheer -->
...
-   *Ketenisse -- erosieve zone (2020/2021 - 2023)*: Erosie waargenomen op de slikken voor Ketenisse schor. 2022-2023 was er geen erosie. Controleren of deze erosie al waargenomen werd 2022-2021. <!--# OK zou ik niet rapporteren -->
-   Fort Filip -- erosieve zone (2021 - 2023): Erosieve zone ten noorden van de strekdam en op Parelplaat voor Fort Filip. Vooral kort na aanleg strekdam in de periode 2021 - 2022. Geen veranderingen groter dan de tolerantiegrens (0.5m) in de laatste verschilkaart <!--# OK - recent in laatste jaar geen verandering, figuur zou ik niet rapporteren, tekstje wel -->
-   *Blokkersdijk -- erosie & sedimentatie (2021 - 2023)*: Erosie en sedimentatie zone waargenomen in het ondiep subtidaal tegenover Blokkersdijk. <!--# deze zone is stortzone 'Oosterweel', zou ik niet rapporteren; voor slik, schorrand beheer niet relevant -->
-   Tussen Oosterweel en Noord Kasteel (2021/2022 - 2023): Strook van erosie op laag slik en ondiep subtidaal aan de rechteroever. Het ondiep water aan linkeroever, langs het Sint-Anna strand, sedimenteert. Dit staat in contract tot de problematiek van het wegspoelen van het intertidaal strand zelf.
...
-   Burchtse Weel -- sedimentatie (2022 - 2023): Sedimentatie strookjes voor Burchtse Weel. <!--# OK zou ik niet rapporteren -->
...
-->
```
```{r 140-figuur-doel, echo=FALSE, fig.cap=caption_doel, out.width="50%"}
...
```{r 140-figuur-europaterminal, fig.cap=caption_europaterminal, out.width="50%", echo=FALSE}
...
```{r 140-figuur-ketenisse, fig.cap=caption_ketenisse, out.width="50%", echo=FALSE}
...
```{r 140-figuur-fortfilip, fig.cap=caption_fortfilip, out.width="50%", echo=FALSE}
...
```{r 140-figuur-blokkersdijk, fig.cap=caption_blokkersdijk, out.width="50%", echo=FALSE}

caption_blokkersdijk <- "Blokkersdijk -- erosie en sedimentatie (2021 - 2023)"
...
```{r 140-figuur-burchtseweel, fig.cap=caption_burchtseweel, out.width="50%", echo=FALSE}
...
-   *Rupelmonde, Notelaer -- erosie & sedimentatie (2020/2021 - 2023)*: In de zone stroomopwaarts de monding van de Rupel, aan de Notelaer is een erosieve zone waargenomen tussen 2020 en 2023, gevolgd door een sedimentatie zone tussen 2021 en 2023. Beide verschijnselen bevinden zich in het laag slik.
-   *Schouselbroek, plaat van Balooi -- erosie & sedimentatie (2020/2021 - 2023)*: Hetzelfde fenomeen van erosie tussen 2020 en 2023 gevolgd door sedimentatie tussen 2021 en 2023 wordt verder stroomopwaarts waargenomen in het laag slik en ondiep subtidaal van de Balooiplaat. Aan de overliggende zijde Groot Schoor Bornem wordt tevens een strook erosie waargenomen tussen 2021 en 2023 in het laag en middelhoog slik.
...
-   Appels -- erosieve zone (2022 - 2023): Nabij Appels wordt een strook erosie waargenomen in het ondiep subtidaal en laag slik. <!--# OK zou ik niet rapporteren, heel beperkt -->
...
-   Kwatrecht -- erosie & sedimentatie (2022 - 2023): Nabij Kwatrecht wordt een sedimentatie waargenomen met zowel stroomop- als stroomafwaarts ook een strook erosie. <!--# OK zou ik niet rapporteren -->
...
-->
```
```{r 140-figuur-rupelmonde, fig.cap=caption_rupelmonde, out.width="50%", echo=FALSE}

caption_rupelmonde <- "Rupelmonde -- erosie en sedimentatie (2020/2021 - 2023)"
...
```{r 140-figuur-schouselbroek, fig.cap=caption_schouselbroek, out.width="50%", echo=FALSE}

caption_schouselbroek <- "Schouselbroek -- erosie en sedimentatie (2020/2021 - 2023)"
...
```{r 140-figuur-temsebrug1, fig.cap=caption_temsebrug1, out.width="50%", echo=FALSE}

caption_temsebrug1 <- "Temsebrug -- erosie en sedimentatie (2020 - 2023)"
...
```{r 140-figuur-temsebrug2, fig.cap=caption_temsebrug2, out.width="50%", echo=FALSE}

caption_temsebrug2 <- "Temsebrug -- erosie en sedimentatie (2021 - 2023)"
...
```{r 140-figuur-durmemonding1, fig.cap=caption_durmemonding1, out.width="50%", echo=FALSE}
...
```{r 140-figuur-durmemonding2, fig.cap=caption_durmemonding2, out.width="50%", echo=FALSE}
...
```{r 140-figuur-appels, fig.cap=caption_appels, out.width="50%", echo=FALSE}
...
```{r 140-figuur-kwatrecht, fig.cap=caption_kwatrecht, out.width="50%", echo=FALSE}

caption_kwatrecht <- "Kwatrecht -- erosie en sedimentatie (2022 - 2023)"
...
*In deze rapportage worden enkel de bathymetrische verschilkaart (2022 versus 2021, 2020 en 2019) besproken.* *Zoals vermeld in de methodologie dienen deze kaarten voornamelijk ter ondersteuning van de interpretatie van erosie van het hoger slik en schorrand, welke slechts 3-jaarlijks gekarteerd worden.* *Zowel in de Boven- als Beneden-Zeeschelde zijn dynamieken waargenomen in enkele zones.* *De waargenomen erosiezones vergen geen directe ingrepen, maar kunnen de voorbode zijn van toenemende erosieve druk en zijn zones van aandacht.* *Meestal kon de dynamiek gelinkt worden aan menselijke activiteiten zoals bagger- en oeverwerken. De waargenomen erosiezones vergen geen directe ingrepen, maar kunnen de voorbode zijn van toenemende erosieve druk en zijn zones van aandacht.*
