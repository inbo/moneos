...
-->
```
```{r 140-figuur-heusden, fig.cap=caption_heusden, out.width="50%", eval=FALSE}
...
```{r 140-figuur-wichelen, fig.cap=caption_wichelen, out.width="50%", eval=FALSE}
...
```{r 140-figuur-hamme, fig.cap=caption_hamme, out.width="50%", eval=FALSE}
...
```{r 140-figuur-mariekerke-diep, fig.cap=caption_mariekerke_diep, out.width="50%", eval=FALSE}
...
```{r 140-figuur-plaatdriegoten-diep, fig.cap=caption_plaatdriegoten_diep, out.width="50%", eval=FALSE}
...
```{r 140-figuur-temsebrug, fig.cap=caption_temsebrug, out.width="50%", eval=FALSE}
