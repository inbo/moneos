...
Op de potentiële pionierzone is op verschillende plaatsen schorvorming ontstaan in 2022. 
Voorbeelden zijn in de Lillo ontpoldering (Figuur \@ref(fig:030-figuur-kaart-lillo)), de heraangelegde zone stroomopwaarts van Fort Filip (Figuur \@ref(fig:030-figuur-kaart-ff)) en eveneens in de Fasseit ontpoldering (Figuur \@ref(fig:030-figuur-kaart-fasseit)). Ook in de Burchtse Weel GGG zette de trend van verschorring zich voort (zie ook Mertens & Van Braeckel, 2022). 

Het schor is verder blijven toenemen, in `r laatste_jaar` met 14,9 hectare ten opzichte van `r laatste_jaar - 1`. Het hoog supralitoraal is licht gedaald met 3,7 hectare.
...
```{r 030-figuur-evolutie-bez, fig.cap=figuur_evolutie_bez, out.width="100%", eval=FALSE}
