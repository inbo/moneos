...
De totale oppervlakte estuarien gebied in de Beneden-Zeeschelde is met 1,9 hectare gedaald. Dit na een stijging van 5,3 hectare in `r laatste_jaar - 1` door de heraanleg rond Fort Filip.  
                       
```{r tekstvorigjaar, eval=FALSE, include=FALSE}
