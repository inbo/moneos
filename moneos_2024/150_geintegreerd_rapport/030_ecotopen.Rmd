...
```{r 030-figuur-kaart-ff, fig.cap='(ref:figff)', out.width="100%", include=FALSE, eval=FALSE}
...
```{r 030-figuur-kaart-bw, fig.cap='(ref:figbw)', out.width="100%", include=FALSE, eval=FALSE}
