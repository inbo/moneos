...
Voor de huidige Beneden-Zeeschelde kaart is gebruikt gemaakt van het meest recente false color beeld van 2022 en de orthofotomozaïek van `r laatste_jaar`.2
...
```{r 030-figuur-kaart-ff, fig.cap='(ref:figff)', out.width="100%", eval=FALSE}
...
```{r 030-figuur-kaart-bw, fig.cap='(ref:figbw)', out.width="100%", eval=FALSE}
...
```{r 030-tabel-oppervlakte-BEZ-2, results="asis", fig.show='hide', out.width="100%",eval=FALSE}
...
```{r 030-tabel-evolutie-BEZ-2, results="asis", fig.show='hide', out.width="100%",eval=FALSE}
...
```{r 030-tabel-oppervlakte-helling-BEZ-2, results="asis", eval=FALSE, fig.show='hide', out.width="100%"}
...
```{r 030-figuur-kaart-bez-2, fig.cap=figuur_ecotopenkaart_bez_2, eval=FALSE, out.width="100%"}
