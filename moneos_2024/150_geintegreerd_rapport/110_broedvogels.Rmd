...
De polders van Kruibeke vromen momenteel het belangrijkste broedgebeid met 10 territoria in 2023, maar de snor heeft zich duidelijk ook gevestigd in de Durmevallei en in de Kalkense Meersen en omgeving.
...
47.
De daling na speelde zich aanvankelijk uitsluitend af in het Noordelijk gebied, van ca.
...
In 2023 werden enkel territoria vastgesteld in het Noordelijk gebied (Doelpolder-noord en Prosperpolder-noord) en de Popolder van Lillo.
...
Maar daarnaast waren er telden we allen in Grote Wal in 2022 al 28 territoria en in 2023 39 territoria.
...
De som van alle gekende territoria blijft ruim onder het doel.
Het doel voor deze soort (IHD = 150) wordt in de Scheldevallei dus niet bereikt.

Het aantal zomertalingterritoria overschreidt in 2022 en 2023 de IHD (20), deels door de hoge aantallen die in het tijdelijke wetland Grote Wal broeden.
In de beperkte set natuurgebieden die voor de algemene soorten onderzocht worden schommelen de aantallen 7 en 11 territoria.
In 2021 lag het aantal nog wat lager omdat er toen geen enkel territorium werd vastgesteld in het Noordelijk gebied.
...
In het Noordelijk gebied lijken de aantallen de laatste jaren wel wat te stijgen, vooral in Doelpolder-noord, waar predatierasters geplaatst zijn om de weidevogels te beschermen, is dit het geval.
