...
In Van de Meutter et al. (2022) een uitgebreide kwaliteitscontrole gepresenteerd van de INBO analysemethode voor korrelgrootteverdeling (adhv een Coultern counter).
...
De selectie van de meest significante modellen is weergegeven in Tabel \@ref(tab:060-tabel-modeloutput). De regressiefiguren worden getoond in 
...
# hoofding tabel
caption_x_waarden <- "Significante (<0.01) lineare regressiemodellen voor slibpercentage voor de waterloop zones per fysiotoop. Estimates tonen de regressie coëfficient - positief betekent toenemende trend"
...
Deze trend kan mogelijk gelinkt worden aan de sterk verhoogde sedimentimport uit de Grote Nete waar het rivierbed zandiger werd en er dus slibrijk materiaal uitspoelde naar afwaarts (Meire et al., 2021).
De veranderingen in de Grote Nete zijn mogelijk veroorzaakt door de activiteit van de Chinese wolhandkrab (Schoelynck et al., 2020). Een lozing met het afsterven van de waterplanten tot gevolg is ook een hypothese.
