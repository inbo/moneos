...
Voor de figuur werd een selectie gemaakt van alle omnivore en benthivore soorten en werden kuifeend en tafeleend uitgesloten omdat beide soorten vooral afhankelijk zijn van het voedselaanbod in de ondiepe waterzones <!--# hangt ervan af wanneer ze foerageren natuurlijk - ik zou denken dat ze vooral foerageerden bij hoog water, en dus eigenlijk op het intertidaal foerageerden? Nu zal dat wrsch anders zijn, en foerageren ze mogelijk op mossels? Overwinterende brilduikers in de Nete foerageerden in de jaren '90 al vooral op driehoeksmossel -->.
...
<br/> <!--# beetje verwarrend vind ik dat in figuur hieronder de Y-as niet bij 0 start, daardoor lijken veel gebieden naar 0 te evolueren, terwijl ze soms op een redelijk hoog plateau hangen -->
...
<br/> **Algemene conclusie** <!--# had vogelgriep een impact op de watervogels? bv kan dit de plots terugval van de (residente?) populatie wilde eend in zoet lang verklaren?  -->
