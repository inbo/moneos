...
De dichtheden in 2023 zijn berekend op basis van de ecotopenkaart 2019 (en dus benaderd).
In de Boven-Zeeschelde zijn de dichtheden de laagste sinds 2001.
In de zone met sterke saliniteitsgradiënt is er een kleine toename in vogeldichtheid.
De dichtheid blijft hier wel laag aangezien ook het voedselaanbod uitgedrukt als biomassa bodemdieren per oppervlakte eenheid niet lager is dan in andere zones.
...
Opvallend is de negatieve trend van de zone zoet lang, vooral veroorzaakt door een sterke afname van de wilde eend.
