...
```{r figuur-indeling-schelde-estuarium, fig.cap = "Ruimtelijke indeling van het Schelde-estuarium volgens de Evaluatie methodiek (EM), KRW en saliniteitszones."}
knitr::include_graphics("../../figuren/moneos_2020/Indeling_schelde_estuarium.png")
```


```{r figuur-waterlichamen, fig.cap = "Overzicht van de Kaderrichtlijn Water waterlichamen."}
knitr::include_graphics("../../figuren/moneos_2020/Kaderrichtlijn_water_waterlichamen.jpg")
```
