...
De densiteit (Figuur \@ref(fig:figuur-densiteit-waterlichaam)) en biomassa (Figuur \@ref(fig:figuur-biomassa-waterlichaam)) in de Zeeschelde s.s. (zonder zijrivieren) zijn relatief stabiel. Rupel en Durme lijken een toename te laten zien.
...
```{r figuur-densiteit-waterlichaam, fig.cap="Densiteit per waterlichaam.", fig.height=18/2.54, fig.width=18/2.54, warning=FALSE}
...
```{r figuur-biomassa-waterlichaam, fig.cap = "Biomassa per waterlichaam.", fig.height=18/2.54, fig.width=18/2.54, warning=FALSE}
...
Door de vastgestelde biomassawaarden (in g per m²) te vermenigvuldigen met de aanwezige oppervlakte aan verschillende ecotopen, kunnen we de totale, in het systeem beschikbare, biomassa berekenen. De hiertoe beschikbare ecotopenkaarten zijn afhankelijk van de afgesproken frequentie waarmee deze voor de verschillende delen van het estuarium gemaakt worden (Tabel \@ref(tab:tabel-ecotopenkaarten)).


```{r tabel-ecotopenkaarten}

tabel_ecotopenkaarten <- read_excel("../tabellen/070_Macrobenthos_tabellen.xlsx", 
