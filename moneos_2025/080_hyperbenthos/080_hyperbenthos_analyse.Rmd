...
ggsave(paste0(pad_figuren, "080-figuur-densiteit_zones.EMSE.jpg"), height=4, width=6)
```
...
ggsave(paste0(pad_figuren, "080-figuur-biomassa_zones.EMSE.jpg"), height=4, width=6)
```
