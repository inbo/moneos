...
-   Verzilting van de zoetwaterschorren lijkt een duidelijke impact te hebben op de zoetwaterschorren nabij de zoet-zout overgang (oligohaliene zone).
...
-   Gelinkt aan de areaaluitbreiding in het kader van het Sigmaplan is er een toename van enkele zeldamere pioniersoorten zoals waterereprijs.
...
Abundantie en biomassa: Er is recent een **negatieve trend** waarneembaar, die sterker is voor biomassa en het meest uitgesproken in de zone Oligohalien.
...
-   Er zijn **veel erosie**ve tendenzen, de hydrodynamiek lijkt de afgelopen tien jaar toegenomen. In de Beneden-Zeeschelde en in Boven-Zeeschelde. In de Beneden-Zeeschelde spelen scheepsgolven waarschijnlijk een toenemende rol in de erosieprocessen.
-   Zoete Zone & Boven-Zeeschelde: In 2025 zijn de morfologische veranderingen geïntensiveerd met **erosieve trends of trendbreuken** op bijna 80% van de gemonitorde raaien in de zoete zone (tussen Durme en Melle).
    ...
    -   Aanbeveling: verder onderzoek is nodig om de oorzaken van deze erosie van habitats te bepalen zodat het beheer kan bijgestuurd worden zodat een meer veerkrachtig, klimaatadaptief ecosysteem in gunstige stand van instandhouding kan gebracht worden.
