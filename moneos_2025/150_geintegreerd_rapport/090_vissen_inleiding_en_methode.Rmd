...
caption_tab <- "Historisch overzicht van de visinspanning  met schietfuiken (groen) en ankerkuil (blauw) in de verschillende zones van de Zeeschelde. Schietfuiken worden doorgaans 48 uur uitgezet, soms 24 uur (*). Ankerkuil omvat twee (voorjaar, najaar) (-) of drie bemonsteringen (voorjaar, zomer, najaar)".
