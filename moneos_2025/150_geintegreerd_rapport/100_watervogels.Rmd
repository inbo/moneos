...
Deze gebieden worden verder niet besproken in het hoofdstuk watervogels.
...
**MIDMA** Alle januari tellingen werden uitgevoerd maar verschillende andere wintertellingen ontbreken voor telseizoen 2024/25.
<!-- -|- -->

<!-- : ontbrekende tellingen MIDMA. {#tbl:100-tabel-ontbrekendedata MIDMA} -->

```{r 100-tabel-ontbrekendedata MIDMA}
...
tabel_ontbrekendedata <- d_ontbrekend %>% 
...
cap_ontbrekendedata <- "Overzicht uitgevoerde Midmaandelijkse tellingen vrijwilligers in telseizoen 2024/25."
...
In 2010 en 2011 waren de vogelaantallen opnieuw iets hoger.
In het winterjaar 2020 (okt '20 - mrt '21) was er een winterinflux door koude temperaturen.
De laatste twee telseizoenen (winter 2023 & 2024) is er een stijging merkbaar in de vogelaantallen langsheen de Zeeschelde.
Dit is niet merkbaar langsheen de zijrivieren (Figuur \@ref(fig:100-figuur-maandelijkse-totalen-winter-Zeeschelde).
...
Specifiek voor de S-IHD doelsoorten werd een trend berekening uitgevoerd voor de lange termijn (sinds 1992) de middellange termijn (sinds 2009, na systeemomslag) en voor de korte termijn.
...
<!-- : R-trim resultaten. {#tbl:100-tabel-rtrim} -->
...
Dit komt sterk overeen met lage gemiddelde biomassa aan macrobenthos maar niet uitzonderlijk laag sinds 2008.
...
<!-- : R-trim resultaten trofische groepen. {#tbl:100-tabel-rtrim-analyse-trofische-groepen} -->
