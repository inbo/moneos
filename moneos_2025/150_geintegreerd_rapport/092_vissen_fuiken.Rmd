...
-   Na een afname in de periode 2009-2015 van het aantal blankvoorns in de fuikvangsten in alle zones behalve het zoet met korte verblijftijd, variëren de aantallen sterk.
    In `r laatste_jaar` werden er relatief veel blankvoorns gevangen in de zone met saliniteitsgradiënt.
    Mogelijks een indicatie van de hoge neerslag in het voorjaar in 2024 en verschuiven van de saliniteitsgradiënt.
...
-   Snoekbaars vangsten in de fuiken blijven relatief stabiel in de laatste 5 jaren met in `r laatste_jaar` lichtjes lagers aantallen in de fuiken.
...
Verder in de zone met sterke saliniteitgradiënt is normaal ook tong goed vertegenwoordigd, in `r laatste_jaar` is dit minder.
