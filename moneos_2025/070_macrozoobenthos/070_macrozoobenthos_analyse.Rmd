...
source("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dZDBwVVJOVk5Ld2s/PRJ_SCHELDE/MONEOS_rapportage/2022/Function_CalculateShannonIndex.R")
...
#is gebeurd in eerdere fase zie G:\\PRJ_SCHELDE\Benthos\Wet weight biomassa en conversies\02-Data.Cleaning.Moneos
...
#groeperen per Taxa_groep maar om later gemiddelde juist te berekenen nu ook missing cases toevoegen
...
ggsave(paste0(pad_figuren, "070-figuur-densiteit-waterlichaam-mediaan_alternatiefTA.jpg"), height=8, width=8)
...
#Figuur densiteit gemiddelde met tijarm
```{r 070-figuur-densiteit-gemiddelde-waterlichaam-alternatief met TIJARMEN}  
...
#Figuur biomassa gemiddelde met tijarm
