...
Figuur 11‑2 toont de evolutie van zes algemene soorten weergegeven in gebieden die frequent worden geteld. Het Noordelijk gebied in de haven van Antwerpen (Sigma_LO op Figuur 11‑2), Blokkersdijk en Ketenisse worden jaarlijks integraal onderzocht op broedvogels. In de Sigmagebieden werd één telling uitgevoerd voorafgaand aan de inrichting (T0) en één tot drie na de inrichting. Het betreft volgende gebieden:
