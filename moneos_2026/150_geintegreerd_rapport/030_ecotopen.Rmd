...
De kaart van het ecotopenstelsel *Zeeschelde 1.0* bestaat van `r vroegste_jaar` tot `r laatste_jaar`, terwijl de kaart van het ecotopenstelsel *Zeeschelde 2.0* teruggerekend is tot en met 2019. <!--# Deze zijn volledig teruggerekend #### voor volgende rapportage aan te passen? -->
...
Voor de Boven-Zeeschelde is dit de eerste rapportage. <!--# De eerste kaart M2 dateert toch uit 2019 voor BEZ en BOZ? Is deze verwoording niet misleidend? -->
...
Deze buitengrens wordt in principe niet steeds aangepast, tenzij de estuariene grens door ingrepen is verlegd. <!--# na te zien -> in workflow hoog supralitoraal wordt Q:\Projects\PRJ_Schelde\Ecotoop\Ecotoopkaart\2022\hoog_supralitoraal.gdb\BOZ_mask_62m_taw /64m_taw gebruikt als clipmask
...
- Antropogeen: Dit ecotoop beschrijft de volledig verharde zones zonder enige ecologische waarde (geen algen noch plantengroei). 
<!-- Klopt dit nog? geomorf = verhard, maar dit ecotoop wordt ook gebruikt in recent vergraven zones. Zie bookmarks in het nazicht.mxd -->
...
Deze stijging komt voor in het ondiep - , het matig diep - en het diep subtidaal.
Respectievelijk met een toename van 11,4; 3,7 en 1,7 ha aan areaal (Tabel \@ref(tab:030-tabel-oppervlakte-BEZ)).
...
In het **supralitoraal** is er voor het schorareaal een toename van 4,8 ha.
Het areaal aan potentiële pionierzone is afgenomen met 9,4 ha en kan verklaard worden door natuurlijke successie waarbij er het voorgaande jaar een hoog aandeel was in ontpolderingen zoals in Lillo en het Paardenschor. 
...
Voor de huidige rapportage zijn enkele correcties (errata) doorgevoerd in de historische ecotopenkaarten. Deze aanpassingen hebben eveneens een weerslag op de oppervlakteboekhouding ten opzichte van voorgaande rapportages:
...
<!-- Ook andere ecotooparealen variëren lichtelijk (bv aandeel hoog supralitoraal uit oppervlaktetabellen van rapportage vorig jaar voor 2020 tov de opptabel van dit jaar) -> hoe kan dit? ####
  Bij opbouw van de tabellen werd altijd verdergebouwd op de Moneos-oppervlaktetabel van het voorgaande jaar. Wanneer er na de rapportage wijzigingen in de ecotopen werden doorgevoerd stroomde dit niet door naar de oppervlaktetabel. Nu is deze tabel opnieuw gegenereerd op basis van de gdb/ecotopen -> een update is doorgevoerd. 
  Het is me niet geheel duidelijk waar de lichte wijzigingen zijn doorgevoerd en deze dienen m.i. niet opgenomen te worden in de errata. Ofwel kort aanhalen als derde bullet point dat er diverse kleine aanpassingen zijn doorgevoerd? -->
...
Enkel het laag slik zacht substraat vertoont een uitgesproken afname in de enge planimietrie, waarmee het het areaal opnieuw op het niveau van `r laatste_jaar - 2`  komt.
...
De tendens uit `r laatste_jaar - 2` dat er in alle diepteklassen een verschuiving heeft plaatsgevonden van hoogdynamisch naar laagdynamisch, zet zich voort in `r laatste_jaar`.
<!--# wat kan deze verschuiving verklaren? --> Vooral in het ondiep- en matig diep subtidaal is er nog een verdere verschuiving van hoog naar laagdynamisch.
...
Debbaut, R., Mertens, A., Vanoverbeke, J. & Van Braeckel, A. 
(2025).
Ecotopen *in* Van Ryckegem, G., Vanoverbeke, J., Van de Meutter, F., Jocqué, M., Vandevoorde, B., Mertens, W., Debbaut, R., Van Praet, A., Van Braeckel, A., Organe, A., Mertens, A., Van Thyune, G., Maesele, R., Smeekens, V., Thibau, K., Buerms, D., Coudenys, A., De Regge, N., Hessel, K., Lefranc, C., Loos, B., Soors, J., Van Lierop, F. (2025). 
