...
Om seizoenale patronen waar te kunnen nemen, voeren we in de lente, zomer en herfst bemonsteringen uit met fuiken.
Sinds 2025 wordt de ankerkuilvisserij volgens een aangepaste bemonsteringsintensiteit uitgevoerd met jaarlijkse afvissingen in de lente en herfst en tweejaarlijkse afvissing in de zomer.
...
Aanvankelijk werd ook op de zijrivieren met getijdewerking jaarlijks gevist maar sinds 2012 werd dit verminderd naar driejaarlijks omdat de totale inspanning te groot werd en omdat de ecosysteem evaluatie vooral op de Zeeschelde zelf gericht is.
...
Dit komt overeen met het deel van de Zeeschelde tot waar de getijdewerking zich rond Gent uitstrekt.

INBO fuikvangst- en ankerkuilgegevens evenals vrijwilligersdata zijn beschikbaar via de V.I.S. databank ([https://vis.inbo.be/](https://vis2.inbo.be/#home)) (Brosens et al., 2015).
...
De gemiddelde hoogte van de waterkolom, die met de duur van het getij verandert, wordt vermenigvuldigd met de kuilbreedte (8 m) en de door de stroomsnelheidsmeter gepasseerde waterstroom.
...
In 2020 werd enkel in de zomer en het najaar gevist.
Vanaf 2025 zal er tweejaarlijks in de zomer gevist worden.
...
De Lambert coördinaten van de locaties zijn: Doel: 143350; 223091, Kennedy (Antwerpen): 149192; 210267, Steendorp: 142898; 200951 en Branst: 137181; 195683.
...
Sinds 2025 is er een bijkomend rooster met vierkanten van 10-10 cm in de toegangshoepel van de fuiken aangebracht om te voorkomen dat bever er in zou kunnen belanden.
Deze maatregel kan een effect hebben op vangst van grote vissen (bvb meerval, snoek of andere).
...
Om de totale visinspanning op de Zeeschelde te rationaliseren, werd de bemonsteringsduur met fuiken in 2022 en 2023 tijdelijk teruggebracht van 48 naar 24 uur, waarbij de fuiken slechts één keer werden leeggemaakt.
In 2024 en 2025 werd opnieuw de oorspronkelijke bemonsteringsmethode toegepast, waarbij de fuiken gedurende 48 uur op locatie stonden en tweemaal werden leeggemaakt.
De tijdelijke verkorting van de bemonsteringsduur in 2022 en 2023 heeft naar verwachting slechts een beperkte invloed op de gemiddelde aantallen en biomassa uitgedrukt per fuikdag.
Voor de soortenrijkdom bleek dat de tweede fuikdag gemiddeld twee bijkomende soorten opleverde, op basis van 144 campagnes.
Bij de interpretatie van de tijdreeks voor soortenrijkdom moet daarom rekening worden gehouden met een mogelijk methode-effect in 2022 en 2023.
Vanaf 2024 zijn de resultaten opnieuw rechtstreeks vergelijkbaar met die van de periode vóór 2022 wat betreft de bemonsteringsduur en het aantal lichtingen.
