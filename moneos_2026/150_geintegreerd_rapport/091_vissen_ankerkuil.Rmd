...
Een toename in het aantal soorten is zichtbaar de laatste jaren in de zone met sterke saliniteitsgradiënt in `r laatste_jaar` vooral in Antwerpen en een lichte afname van het aantal soorten de laatste jaren in de oligohaliene zone (Steendorp) (Tabel \@ref(tab:091-tabel-aantal-soorten)).
...
In het najaar neemt grondel het over in Steendorp en in Branst, vergelijkbaar met vorig jaar.
...
In het najaar is spiering dominant over de volledige saliniteitsgradiënt van de zone met sterke saliniteit tot de zoete zone (Figuur \@ref(fig:091-figuur-relatieve-biomassa)), met duidelijke aanwezigheid van grondel en snoekbaars van Antwerpen tot Branst.
...
In `r laatste_jaar` zijn voor het eerst 7 benthivore soorten in de zone met sterke saliniteitsgradieënt waargenomen.
...
Desondanks de dominantie van spiering zijn in recente jaren de aantallen een stuk lager (50-600 individuen per 1000m³).
...
Een patroon voor snoekbaars ook aanwezig voor de biomassa in de zone zoet lang.
...
Na een uitschieter in 2021 zijn aantal en biomassa de laatste jaren, evenals in `r laatste_jaar` laag.
...
- Bot komt voor in alle drie de scheldezones waar afvissingen met ankerkuil worden gedaan, maar met over het algemeen de hoogste aantallen in het zoetwater.
  Aantallen bot varieren van jaar tot jaar, met in `r laatste_jaar` een verdere sterke afname sinds vorig jaar.
...
- Paling wordt vooral gevangen in het oligohalien en zoetwater.
  De aantallen blijven stabiel in `r laatste_jaar`.
...
- Brasem vertoont een duidelijke toename in aantallen in het zoetwater vanaf 2016 in vergelijking met de jaren ervoor.
  De sterke daling ingezet in 2024 zet zich verder In `r laatste_jaar`, vooral in het zoetwater.
...
- Ook snoekbaars vertoont een duidelijke toename in aantallen vanaf 2016 met een piek in 2021 waarna de aantallen terug afnemen.
  Deze soort komt niet alleen voor in het zoetwater maar ook vaak in het oligohalien, waar in `r laatste_jaar` de sterkste afname in aantallen is waargenomen, en zelfs in de zone met sterke saliniteitsgradiënt.
...
Voor alle drie de estuariene habitat gebruik groepen zien we de laagste densiteiten in de zone met sterke saliniteitsgradiënt en zoetwaterzone.
Tien jaar geleden (2014) overheersten diadrome vissen de aantallen in de ankerkuilvangsten, met vergelijkbare aantallen per m³ in de oligohaliene en zoete zone.
Die dominantie was hoofdzakelijk te wijten aan de grote aantallen en biomassa van spiering in voorgaande jaren.
De laatste drie jaar zijn de aantallen en biomassa een stuk lager en overheersen mariene en estuariene soorten, waar die in het verleden met bijna een factor 10 minder gevist werden.
Vooral opvallend is dat in 2025 voor alle estuariene habitat gebruik groepen in de drie saliniteitszones gekemerkt is wordt door zeer lage gevangen aantallen.
...
Spieringen zijn zonder meer de dominante trekvissen, zowel naar aantal als naar biomassa en dat geldt in alle saliniteitszones van de Zeeschelde.
De aantallen spiering zijn al een aantal jaren veel kleiner dan voorheen, in 2022, 2023 en `r laatste_jaar` echter zijn niet alleen de aantallen maar ook de biomassa's uitzonderlijk laag.
...
In de zone met sterke saliniteitgradiënt is haring, een mariene migrant het meest aanwezig, evenals sprot in 2022 en `r laatste_jaar`.
Gelijkaardige patronen zijn zichtbaar op basis van biomassa en dit tot in het oligohalien.
Mariene migranten zoeken de beschutting en voedselrijkdom van het estuarium op tot in de zoetwater zone.
De aantallen en biomassa's variëren sterk van jaar tot jaar maar zijn laag in `r laatste_jaar`.
...
zoals reeds vermeld is de dominantie van omnivoren (spiering) de laatste drie jaar echter grotendeels verdwenen.

Brakwatergrondel en dikkopje en in mindere mate brasem zijn de dominante benthivoren zowel in aantallen als in biomassa.
In `r laatste_jaar` zijn de aantallen grondels (brakwatergrondel en dikkopje) laag in aantal en biomassa.

Spiering is de dominante omnivoor met hogere aantallen en biomassa dan snoekbaars en andere omnivoren.
