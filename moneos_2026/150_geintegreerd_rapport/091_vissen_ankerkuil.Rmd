...
Een lichte toename in het aantal soorten is zichtbaar de laatste jaren in de zone met sterke saliniteitsgradiënt (vooral Antwerpen) en een lichte afname van het aantal soorten de laatste jaren in de oligohaliene zone (Steendorp) (Tabel \@ref(tab:091-tabel-aantal-soorten)).
...
In de zone met sterke saliniteitsgradiënt zijn haringachtigen (Doel en Antwerpen) dudielijk dominant in het voorjaar van `r laatste_jaar`.
In het najaar komen op deze locaties spiering (Doel) en spiering en sprot (Antwerpen) voor.
<!--# wat is dat grijs? --> Haringachtigen zijn zijn ook dominant in Steendorp tijdens het voorjaar.
Spiering is dominant in Branst tijdens het voorjaar.
In het najaar neemt brakwatergrondel het over in Steendorp en ook in Branst, vergelijkbaar met vorig jaar.
Bot is dominant in Branst tijdens de zomer en duidelijk aanwezig in Steendorp en Antwerpen.

Uitgedrukt in biomassa zijn haringachtigen dominant in de zone met sterke saliniteitsgradiënt (Doel) in het voorjaar.
Spiering overheerst in de oligohaliene (Antwerpen) en zoete (Steendorp) zone in het voorjaar.
...
In het najaar is spiering dominant over de volledige saliniteitsgradiënt van de zone met sterke saliniteit tot de zoete zone (Figuur \@ref(fig:091-figuur-relatieve-biomassa)).
...
In `r laatste_jaar` vallen de lage relatieve aantallen op, met vooral de sterke afname van brakwatergrondel in de zoet lange zone en de oligohaliene zone in vergelijking met vorig jaar.
Brasem is nu dominant.

Omnivore mariene en estuariene soorten worden qua aantallen in het verleden gedomineerd door kleine zeenaald in de zone met sterke saliniteitsgradiënt, en ook in `r laatste_jaar` is dit het geval.
In het oligohalien en zoetwater komt hoofdzakelijk juveniele zeebaars voor die daar komt opgroeien.
De aantallen zijn beduidend lager dan vorig jaar.
...
In `r laatste_jaar` zijn de aantallen en biomassa opvallend laag en domineren haringachtigen.
...
De dominatie van kleine zeenaald in aantallen is hier niet zichtbaar en wordt vervangen door grote zeenaamd, zeebaars en wijting.
...
In 2022, 2023, 2024 en `r laatste_jaar` zijn de aantallen en biomassa aan gevangen spiering echter opvallend lager, vooral in de zoetwater zone en ze blijven gestaag dalen.
...
De aantallen en biomassa daalden in `r laatste_jaar`.
...
- Brakwatergrondel komt in de grootste aantallen voor in het zoetwater en vertoont piekdensiteiten rond 2018.
  Na een dieptepunt in 2019 zetten de waargenomen aantallen in `r laatste_jaar` een continue stijging verder.

- Dikkopje is in `r laatste_jaar` aanwezig in lage aantallen.
...
- Haring komt vooral voor in de zone met sterke saliniteitsgradiënt.
  De aantallen blijven in `r laatste_jaar` afnemen en tonen op eerste zicht een golvende beweging, met piekdensiteiten in 2014, 2018 en 2022.

- Zeebaars wordt vooral waargenomen in de zoetwater zone en in het oligohalien.
  Na een sporadische aanwezigheid in de periode 2018-2023 is er in `r laatste_jaar` een duidelijke toename van zeebaars in de Zeeschelde.
...
- Bot komt voor in alle drie de scheldezones waar afvissingen met ankerkuil worden gedaan, maar met over het algemeen de hoogste aantallen in het zoetwater.
  Aantallen bot varieren van jaar tot jaar, met in `r laatste_jaar` een afname sinds vorig jaar doch nog altijd met hoge aantallen.

- Fint aantallen vertoonden pieken in 2012, 2015 en 2017 en ook terug een piek in `r laatste_jaar`.
...
- Brasem vertoont een duidelijke toename in aantallen in het zoetwater vanaf 2016 in vergelijking met de jaren ervoor.
  In `r laatste_jaar` is er een sterke daling, vooral in het zoetwater.
...
Tien jaar geleden (2014) overheersden diadrome vissen de aantallen in de ankerkuilvangsten, met vergelijkbare aantallen per m³ in de oligohaliene en zoete zone.
...
Zoetwatersoorten worden tenslotte in veel lagere aantallen gevangen, weliswaar met duidelijke toename van aantallen in stroomopwaartse richting.
...
Afgezien van de uitzonderlijke piek in 2023 voor dikkopje is er vooral een graduele toename van aantallen en biomassa's van brakwaterrondel zichtbaar sinds 2019.

In de zone met sterke saliniteitgradiënt is haring, een mariene migrant het meest talrijk, evenals sprot in 2022 en `r laatste_jaar`.
...
In `r laatste_jaar` is brakwatergrondel dominant in aantallen en biomassa in zoetwater.
...
In de zone met sterke saliniteitsgradiënt zijn haring en sprot de belangrijkste planktivoren, met een zeer opvallende piek in 2022 en ook een goede piek in `r laatste_jaar`.
