...
Na het beperkt aantal soorten van vorig jaar is dit een terugkering naar een gemiddeld aantal soorten in de opvolging van het visbestand.
Een overzicht van de soorten gevangen in `r laatste_jaar` is weergegeven in Tabel \@ref(tab:091-tabel-overzicht-soorten).
De laatste jaren neemt het aantal soorten toe in de zone met een sterke saliniteitsgradiënt, waarbij deze toename in `r laatste_jaar` vooral in Antwerpen duidelijk zichtbaar is. In de oligohaliene zone, ter hoogte van Steendorp, is daarentegen de laatste jaren een lichte afname van het aantal soorten waarneembaar. (Tabel \@ref(tab:091-tabel-aantal-soorten)).
...
Op elke locatie kan tot een derde van de aangetroffen soorten tussen de seizoenen verschillen. Het totaal aantal soorten jaarlijks gevangen in de Zeeschelde (over alle locaties) in de periode `r vroegste_jaar`-`r laatste_jaar` varieert rond de 40, met een maximum (46) in 2017 en een minimum (34) in 2024. In 2025 werden 42 soorten waargenomen.
...
Juveniele haring en sprot werden samen geregistreerd als "haringachtigen" <!--# toch eens nagaan of dit methode is die gaat aangehouden worden in de komende jaren? -->.Juveniele brakwatergrondel en dikkopje zijn moeilijk uiteen te houden en worden als grondel sp. opgenomen.  
...
In het najaar neemt grondel het over in Steendorp en in Branst. Dit is vergelijkbaar met vorig jaar.
...
In `r laatste_jaar` zijn de aantallen en biomassa opvallend laag en gaat het vooral om sprot.
...
De sterke dominantie van één of twee soorten qua aantallen binnen elke soortgroep is ook duidelijk zichtbaar in Figuur \@ref(fig:091-figuur-diversiteit-marien-EMSE) die het aantal soorten (S) en de Shannon-diversiteit (D) weergeeft. Zelfs als er in totaal (S) 5 of meer soorten voorkomen in een groep wordt deze meestal door slechts één of twee soorten gedomineerd (D).
...
De diadrome soorten in de Zeeschelde zijn  voornamelijk omnivoor en gedomineerd door spiering (Figuur \@ref(fig:091-figuur-aantallen-diadroom-EMSE)). De dominantie van spiering is dermate dat bot, driedoornige stekelbaars, fint en paling, die nochtans ook zeer regelmatig gevangen worden, niet zichtbaar op de figuur zijn en samen met minder algemene soorten onder 'rest' vallen.

Spieringen zijn het meest talrijk in de oligohaliene en zoetwater zone met pieken tot 4000-6000 individuen per 1000 m³ in 2014. Desondanks de dominantie van spiering zijn in recente jaren, en dan vooral sinds 2022, de aantallen een stuk lager (50-600 individuen per 1000 m³).
...
De aantallen daalden in `r laatste_jaar` voor het vierde jaar op rij. Hetzelfde afnemende patroon voor snoekbaars is ook aanwezig voor de biomassa in de zone zoet lang.
...
- Bot komt voor in alle drie de afgeviste scheldezones, met de hoogste aantallen in het zoetwater.De aantallen bot vertonen de laatste drie jaar sterke schommelingen, met een uitgesproken piek in 2023, vooral in de zoetwaterzone. Na deze piek nemen de aantallen in 2024 en 2025 opnieuw af.

- Fint aantallen vertoonden pieken in 2012, 2015 en 2017 en 2024.
  In `r laatste_jaar` is fint maar beperkt aanwezig. Er was in 2025 ook geen ankerkuil zomercampagne, terwijl dit net de periode is wanneer de juveniele individuen normaal gevangen worden (zoals de piek in 2024). Daarnaast kan sterke variatie in de aantallen ook aan de paaitrek als aan het rekruteringssucces te wijten zijn.
...
- Paling aantallen fluctueren de laatste drie jaar, zonder een eenduidige temporele trend. De hoogste aantallen worden doorgaans in de zoete en oligohaliene zone aangetroffen, terwijl paling in de zone met sterke saliniteitsgradiënt slechts in lage aantallen wordt gevangen.
...
- Spiering is in het algemeen de soort met de hoogste aantallen en biomassa in de Zeeschelde (zie ook Figuur \@ref(fig:091-figuur-relatief-aantal), \@ref(fig:091-figuur-relatieve-biomassa), \@ref(fig:091-figuur-aantallen-diadroom-EMSE) en \@ref(fig:091-figuur-biomassa-diadroom-EMSE)).
  De aantallen spiering blijven de laatste drie jaar relatief laag en vertonen geen duidelijke trend. De hoge aantallen die in sommige eerdere jaren werden waargenomen, met een uitgesproken piek in 2014, komen in de recente bemonsteringen niet meer voor.
...
- Blankvoorn wordt doorgaans in lage aantallen gevangen, met uitzondering van een opvallende piek in 2021 in de zoete zone. De laatste jaren blijven de aantallen opnieuw laag.
...
- Snoekbaars neemt vanaf 2016 toe, vooral in de zoete en oligohaliene zone, met pieken rond 2020–2022, waarna de aantallen opnieuw afnemen. In de zone met sterke saliniteitsgradiënt blijven de aantallen beduidend lager.
...
In één oogopslag is te zien dat met de ankerkuil de hoogste visdensiteiten (aantal vissen per m³) worden aangetroffen in de zoete zone en de laagste in de zone met sterke saliniteitsgradiënt. Hetzelfde patroon is zichtbaar voor de biomassa. Als we geen rekening houden met verschillen in lokale hydromorfologische omstandigheden tussen de bemonsteringslocaties, suggereren de ankerkuilvangsten dat de densiteit van de pelagische visgemeenschap in de Zeeschelde toeneemt in stroomopwaartse richting.
...
De densiteit van de verschillende functionele groepen vertoont een duidelijke ruimtelijke gradiënt. Mariene en estuariene soorten worden in de hoogste aantallen gevangen in de zone met sterke saliniteitsgradiënt, terwijl zoetwatersoorten vooral in de zoete zone hogere densiteiten bereiken. Diadrome soorten kwamen in het verleden in hoge aantallen voor in zowel de oligohaliene als de zoete zone. Rond 2014 domineerden zij de ankerkuilvangsten sterk, voornamelijk door de zeer hoge aantallen en biomassa van spiering. De laatste jaren zijn de aantallen en biomassa van diadrome soorten sterk afgenomen. Hierdoor bepalen mariene en estuariene soorten in toenemende mate de totale aantallen, terwijl hun densiteiten in het verleden beduidend lager lagen. In 2025 vallen bovendien de zeer lage vangstaantallen op: in alle drie de saliniteitszones werden voor de verschillende functionele groepen slechts lage densiteiten vastgesteld.
...
De aantallen spiering zijn al een aantal jaren veel kleiner dan voorheen, en nemen sinds 2022 af.Ook de biomassa's zijn uitzonderlijk laag. Dit vergt nader onderzoek.
...
In de zone met sterke saliniteitsgradiënt zijn vooral haring en sprot belangrijke mariene migranten. Verder stroomopwaarts verandert de soortensamenstelling en worden onder meer brakwatergrondel en dikkopje belangrijker. Vooral dikkopje levert in recente jaren lokaal een belangrijke bijdrage aan de biomassa, tot in de zoete zone. De aantallen en biomassa van mariene en estuariene soorten variëren sterk van jaar tot jaar en zijn in 2025 relatief laag.
...
Wat de trofische samenstelling betreft, werden de vangsten in het verleden in de oligohaliene en zoete zone in verschillende jaren sterk gedomineerd door omnivoren. Dit was voornamelijk het gevolg van de hoge aantallen en biomassa van spiering. Benthivoren en planktivoren vormden eveneens een belangrijk aandeel van de vangsten, terwijl piscivoren zowel in aantal als biomassa slechts een beperkte bijdrage leverden. De dominantie van de omnivoren is de laatste drie jaar sterk afgenomen door de terugval van spiering.

Binnen de benthivoren zijn vooral brakwatergrondel en dikkopje bepalend voor de vangsten, aangevuld met onder meer brasem. De relatieve bijdrage van deze soorten verschilt tussen jaren en saliniteitszones. In 2025 zijn de aantallen en biomassa van grondels, waaronder brakwatergrondel en dikkopje, relatief laag.

Spiering bepaalt in belangrijke mate de aantallen en biomassa van de omnivoren en is in verschillende jaren veel talrijker dan snoekbaars en de overige omnivore soorten. Deze indeling moet echter worden genuanceerd: een groot deel van de gevangen spieringen bestaat uit juveniele individuen, die voornamelijk planktivoor zijn. Hoewel spiering hier op soortniveau als omnivoor wordt ingedeeld, bestaat een belangrijk deel van de visgemeenschap in het pelagiaal van de oligohaliene en zoete Zeeschelde functioneel dus uit planktivore individuen.
