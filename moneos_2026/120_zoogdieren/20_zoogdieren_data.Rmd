...
# two tables delivered from waarningen.be, one with standard data, one with data for which observer had to give consent
...
list.files(str_replace(pad_data, "2026", "2025"))
