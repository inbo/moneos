...
# OPGELET!!!
  ...
  data2021 <- read_excel(paste0(pad_data, "basis_sediment_SP21VLIZ.xlsx")) 
  ...
  data <- read_excel(paste0(pad_data, "S_DS_V_004a_sediment_data2008_2020_rapportage2022.xlsx"))
  
  data <- data %>% 
    select(jaar, campagne, waterloop, tidaal, fysiotoop, locatie, X, Y, variabele, waarde_punt) %>% 
    rename(waarde = waarde_punt)
