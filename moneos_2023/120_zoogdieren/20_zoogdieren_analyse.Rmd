...
# utm_tmmap_list[[2]]
# utm_tmmap_list[[8]]
# utm_tmmap_list[["Grijze Zeehond_2021"]]
...
m <- utm_tmmap_list[["Europese Bever_2019"]]
tmap_save(m, filename = paste0(pad_figuren, "bever2019.png"))
m


tmapsave <- function(x){
  tmap_save(x, filename = str_c(pad_figuren, names()))
}
map(utm_tmmap_list, tmapsave)
class(utm_tmmap_list[12])
names(utm_tmmap_list)
```
