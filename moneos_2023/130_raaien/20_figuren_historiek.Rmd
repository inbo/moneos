    ...
    dat_raai <-
      ...
      arrange(Datum, distance_prof)
        ...
        p <- 
          ...
          scale_y_continuous(breaks = pretty(dat_raai$distance_prof, 10)) +
...
walk2(figuren_MONEOS$Naam, figuren_MONEOS$fig, 
      ~ggsave(.y, file=str_c(pad_figuren, .x, "_", campagne, ".png"), 
