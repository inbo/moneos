...
```{r relatie soortaantallen vs aantal soorten, eval=FALSE}
...
relatieve_aantallen_EMSE <- 
  ...
  mutate(aantal_per_fuikdag = relatief_aantal*aantal_per_fuikdag)
...
relatieve_aantallen_EMSE <- 
  ...
  mutate(gewicht_per_fuikdag = relatief_gewicht*gewicht_per_fuikdag)
