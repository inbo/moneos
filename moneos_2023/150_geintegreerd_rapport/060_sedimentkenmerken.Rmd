...
In de Zeeschelde wordt het sediment sinds 2011 slibrijker in het intertidale gebied en in het ondiep en ook matig diep subtidaal (Figuur \@ref(fig:060-figuur-slib-Zeeschelde-intertidaaltrend) en Figuur \@ref(fig:060-figuur-slib-Zeeschelde-subtidaaltrend)). In de diepere delen is de variatie groter en zonder duidelijk patroon. In Zeeschelde III is de variatie in de gemeten sedimentkarakteristieken groot. 
Deze tendens tot slibrijkere sedimenten is ook zichtbaar in de Rupel (min of meer vanaf 2011) maar is niet duidelijk in de zijrivieren Figuur \@ref(fig:060-figuur-slib-zijrivieren-intertidaaltrend) en Figuur \@ref(fig:060-figuur-slib-zijrivieren-subtidaaltrend)). De opslibbing van de Durme met slibrijke sedimenten is ook duidelijk zichtbaar in de figuren. In de overige zijrivieren werden geen sedimentstalen genomen in 2018, 2019 en 2021. Een diepgaander analyse van de data is nodig om statistisch de trends te onderbouwen en correlaties te zoeken met mogelijk verklarende factoren.
...
slib_Zeeschelde_intertidaaltrend <- paste0("Slibgehalte (\\%) – Zeeschelde intertidaal. Geen data in 2015 en 2013 voor intertidaal Zeeschelde IV. Loess smoother als trendlijn (data 2008-",recentste_jaar,").")
...
slib_Zeeschelde_subtidaaltrend <- paste0("Slibgehalte (\\%) – Zeeschelde subtidaal. Geen data in 2013 voor subtidaal Zeeschelde I. Loess smoother als trendlijn (data 2008-",recentste_jaar,").")
...
slib_zijrivieren_intertidaaltrend <- paste0("Slibgehalte (\\%) – zijrivieren intertidaal. In 2018 en 2019 werden de zijrivieren Nete, Dijle en Zenne niet bemonsterd. Loess smoother als trendlijn (data 2008-",recentste_jaar,").")
...
slib_zijrivieren_subtidaaltrend <- paste0("Slibgehalte (\\%) – zijrivieren subtidaal. In 2018 en 2019 werden de zijrivieren Nete, Dijle en Zenne niet bemonsterd. Loess smoother als trendlijn (data 2008-",recentste_jaar,").")
