...
<!--# Tabellen hebben verschillende fontsize -->
...
Omnivore mariene en estuariene soorten worden qua aantallen gedomineerd door kleine zeenaald in de zone met sterke saliniteitsgradiënt en in het oligohalien en zoetwater door, hoofdzakelijk juveniele, zeebaarzen die daar komen opgroeien.
...
<!--# Ik zie hieronder enkel een beschrijving van de aantallen, geen ecologische eigenschappen -->
...
-   Spiering is in het algemeen de soort met de hoogste aantallen en biomassa in de Zeeschelde (zie ook Figuur \@ref(fig:091-figuur-relatief-aantal), \@ref(fig:091-figuur-relatieve-biomassa), \@ref(fig:091-figuur-aantallen-diadroom-EMSE) en \@ref(fig:091-figuur-biomassa-diadroom-EMSE)).
    ...
    In `r laatste_jaar` werden de laagste aantallen en biomassa ooit gevangen.
...
Men zou dus kunnen besluiten dat de densiteit van de vispopulaties in de Zeeschelde stijgt in stroomopwaartse richting als we abstractie maken van de verschillen in morfodynamische habitateigenschappen op de verschillende visplaatsten.
...
<!--# Ik blijf het eigenaardig vinden dat de aantallenpiek in 2014 veel groter is dan die van de biomassa, dat moeten we toch wel eens nader bekijken -->.
...
Snoekbaars is de dominante zoetwatersoort, eveneens in aantal en biomassa, maar de dominantie is minder uitgesproken dan die van de spiering, o.a.
