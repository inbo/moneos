...
cap_aantal_soorten_locatie <-
  str_c("Het aantal gevangen soorten in de Zeeschelde per locatie tijdens de ankerkuilcampagnes in de Zeeschelde in de periode 2012-",laatste_jaar,". Het donkere deel per balk geeft het gemiddeld aantal gevangen soorten per seizoen (en locatie); het lichtere deel geeft het totaal aantal gevangen soorten over de seizoenen (en locaties).")
...
In de zoete zone is dat eerder brakwatergrondel en snoekbaars.
...
Omnivore mariene en estuariene soorten worden qua aantallen gedomineerd door kleine zeenaald in de zone met sterke saliniteitsgradiënt en door, hoofdzakelijk juveniele, zeebaarzen die in het oligohalien en zoetwater komen opgroeien.
...
Zelfs als er in totaal (S) 5 of meer soorten voorkomen in een groep worden de functionele groepen gedomineerd meestal door één of twee soorten (D).
...
Met uitzondering van een dip rond 2016 en een piek in 2019 in het oligohalien (≈ 700 individuen per 1000m³) was de biomassa aan spiering in voorgaande jaren relatief stabiel.
...
Om het recruteringssucces te bepalen moet echter de grootteklasse verdeling per seizoen en per locatie geanalyseerd worden.
...
Bij de Benthische soorten vertoont Brasem `r laatste_jaar` in opvallend hoge aantallen.
Dit weerspiegelt zich niet in de biomassa, wat aangeeft dat er vooral kleine specimens zijn gevangen.
Na uitschieters in 2022 zijn de aantallen in `r laatste_jaar` weer gedaald voor omnivore en piscivore zoetwatersoorten in de zoetwaterzone.
...
-   Dikkopje komt meestal in de hoogste aantallen voor in het oligohalien.
    Na hoge densiteiten in 2018 en 2020 komen er in 2021 en `r laatste_jaar` slechts lage aantallen voor.
...
-   Spiering is in het algemeen de soort met de hoogste aantallen en biomassa in de Zeeschelde (zie ook Figuur \@ref(fig:091-figuur-relatief-aantal), \@ref(fig:091-figuur-relatieve-biomassa), \@ref(fig:091-figuur-aantallen-diadroom-EMSE) en \@ref(fig:091-figuur-biomassa-diadroom-EMSE)).
    ...
    In `r laatste_jaar` werden opvallend lage aantallen en biomassa gevangen.
...
-   Brasem vertoont een duidelijke toename in aantallen in het zoetwater vanaf 2016 in vergelijking met de jaren ervoor.
    In `r laatste_jaar` pieken de antallen in het zoetwater.
...
In de EMSE methodiek worden twee van deze kenmerken gebruikt, het gebruik van estuariene habitats en het dieet, en werd beslist om deze te 'nesten' waardoor er 12 functionele groepen gevormd werden.

Alternatief kunnen we ook het gildenconcept toepassen zoals gebruikelijk en enerzijds het estuarien habitat gebruik door de visgemeenschap evalueren en anderzijds de positie van de visgemeenschap te positioneren in het estuariene voedselweb.
...
Baars, rivierprik en zeeprik zijn de dominante piscivoren die in kleine en sterk wisselende aantallen gevangen worden.
In aantallen overheerst baars, maar prikken kunnen bepalend zijn in de biomassa.
