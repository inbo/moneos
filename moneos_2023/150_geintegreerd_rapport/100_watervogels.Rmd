...
De vleeseters (roofvogels) worden niet systematisch geteld bij de watervogeltellingen.
...
De globale patronen in de maandelijkse wintervogelaantallen langsheen de Zeeschelde op de slikken (zonder Sigma natuurontwikkelingsgebieden) zijn de laatste jaren dalend (Figuur \@ref(fig:100-figuur-maandelijkse-totalen-winter-Zeeschelde)).
De vogelaantallen namen sterk af tussen 2002 en 2007.
Tussen 2008 en 2010 waren er hogere aantallen en in 2020 was er een duidelijke winterinflux door de koude temperaturenwas maar globaal zijn sinds 2012 zijn de vogelaantallen verder afnemend.
...
Winter `r laatste_telseizoen` is er voor het vierde jaar op rij een stijging in het aantal benthivore overwinteraars (voornamelijk steltlopers) in de zone met sterke saliniteitsgradiënt.
...
Dit is vooral te wijten aan een sterke afname van de wilde eend.
...
Ook in de zone met sterke salniteitsgradiënt nemen de herbivoren toe, dit is vooral te wijten aan de hogere aantallen krakeend.
...
De diversiteit is ook laag langsheen de Durme.
...
De gemiddelde wulpaantallen namen af.
...
De diversiteit is het grootst in de zone met een sterke saliniteitsgradiënt waar de laatste 3 jaar ook een duidelijke toename werd vastgesteld van benthivore steltlopers (scholekster en bergeend).
