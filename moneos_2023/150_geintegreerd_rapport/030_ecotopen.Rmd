...
De kaart van het ecotopenstelsel 1.0 bestaat van `r laatste_jaar` tot `r vroegste_jaar`, terwijl de kaart van het ecotopenstelsel 2.0 maar teruggerekend is tot en met 2019.
...
De grens tussen laag en middelhoog slik blijft 25%DD in saliniteitszones "Mesohalien" en "Zone met sterke saliniteitsgradiënt" (brak), maar verschuift naar 35%DD in de rest van de Zeeschelde (Figuur @ref(fig:030-figuur-salzones)).
...
```{r 030-figuur-salzones, fig.cap=figuur_kaart_salzone, out.width="100%"}

figuur_kaart_salzone <- "Saliniteitszones in de Zeeschelde met overgang brak - zoet."

knitr::include_graphics(paste0(pad_figuren, "030_figuur_saliniteitszones_grens.png"))
