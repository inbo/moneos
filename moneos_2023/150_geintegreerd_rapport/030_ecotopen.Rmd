...
Ongeveer de helft van deze toename heeft plaatsgevonden binnen de laterale uitbreidingen.
...
De korte en lange termijn evolutie van de ecotopen is opnieuw beschreven in Tabel \@ref(tab:030-tabel-evolutie-BEZ-2) via de absolute verandering (ha) en de procentuele verandering (%) tussen de 2 jaren.
...
Het aandeel laagdynamisch is relatief groter in het ondiep subtidaal.
In het diep subtidaal is het aandeel laagdynamisch toegenomen over de korte termijn evolutie, terwijl het hoogdynamisch licht is afgenomen.
In het matig diep subtidaal zijn zowel hoog- als laagdynamisch afgenomen, deze afname is sterker voor het hoogdynamisch.
...
In de ecotopen 2.0 is het laag slik zacht substraat afgenomen, net als in de ecotopen 2.0.
Hetzelfde geldt voor de toename van het middelhoog slik, al is deze kleiner voor de ecotopen 2.0.
