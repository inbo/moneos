...
De korte en lange termijn evolutie van de ecotopen is beschreven in Tabel \@ref(tab:030-tabel-evolutie-BEZ) via de absolute verandering (ha) en de procentuele verandering (%) tussen de 2 jaren.
...
In `r laatste_jaar` is het **sublitoraal** licht afgenomen ten opzichte van `r laatste_jaar - 1` (Tabel \@ref(tab:030-tabel-evolutie-BEZ)), maar de oppervlaktes blijven groter dan deze in `r laatste_jaar - 2` (Tabel \@ref(tab:030-tabel-oppervlakte-BEZ)).
...
Tabel \@ref(tab:030-tabel-oppervlakte-BEZ-2) toont voor `r laatste_jaar` de oppervlaktes per ecotoop in de Beneden-Zeeschelde `r laatste_jaar` volgens ecotoopindeling 2.0 en een vergelijking met de berekening volgens ecotopen 1.0.
...
knitr::include_graphics(paste0(pad_figuren, "003_figuur_Ecotoop_BEZ_", laatste_jaar, "_20.png"))
