...
In het **litoraal** is het zacht substraat in totaal ook met 0,7 hectare toegenomen sinds `r laatste_jaar - 1`.
Dit komt door een grote toename in het middelhoog slik, aangezien zowel het laag slik als het hoog slik zijn afgenomen in oppervlakte.
...
Voor een gedeelte is deze schortoename zichtbaar in de GGG Burchtse Weel, waarbij grote delen potentiële pionierzone inmiddels begroeid zijn (Figuur \@ref(fig:030-figuur-kaart-bw)).
