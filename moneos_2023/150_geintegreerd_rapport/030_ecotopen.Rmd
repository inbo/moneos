...
Naast "Zacht (onbegroeid) substraat", worden ook volgende harde substraattypes onderscheiden:
...
Verder wordt de schorgrens of het begroeide deel ingetekend als "Schor- en dijkvegetatie" en worden de "GetijdeplassenG aangeduid. De kaart wordt gemaakt aan de hand van enerzijds false colour beelden genomen bij laag water eens in de drie jaar (in opdracht van De Vlaamse Waterweg) en anderzijds orthofotomozaïeken van Vlaanderen voor de tussenliggende jaren (deze zijn niet altijd bij laag water genomen). Voor de huidige Beneden-Zeeschelde kaart is gebruikt gemaakt van het false color beeld van 2019 en de orthofotomozaïek van `r laatste_jaar`. De grenzen worden hierop ingetekend, vertrekkende van de grenzen van het voorgaande jaar, door personen met een uitgebreide terreinkennis. Figuur \@ref(fig:030-figuur-geomorfkaart) toont een voorbeeld van de geomorfologische kaart 2021 ter hoogte van schor Ouden Doel met links het false color beeld van 2019 bij laag water en rechts de orthofotomozaïek van 2021.
...
In de **sublitorale zone** worden 4 fysiotopen onderscheiden op basis van diepte onder het gemiddeld laagwater bij springtij.
...
In het ecotopenstelsel *Zeeschelde 2.0* blijven de dieptegrenzen gehandhaafd, maar daarbovenop worden hoog- en laagdynamische habitats onderscheiden.
...
Binnen deze zone worden 3 litorale fysiotopen onderscheiden op basis van precentages van de droogvalduur (DD):

-   Laag slik: tussen LW 30% en DD 25%
-   Middelhoog slik: tussen DD 25% en DD 75%
-   Hoog slik: tussen DD 75% en HW 85%

In de *ecotopenkaart versie 2.0* worden andere en niet overal dezelfde droogvalduurgrenzen gehanteerd, op basis van de verspreiding van bodemdiergemeenschappen (Tabel \@ref(tab:030-tabel-slik-ecotopen)).
...
In de **supralitorale zone** worden vervolgens nog twee fysiotopen onderscheiden:

-   supralitoraal
-   hoog supralitoraal

Het supralitoraal is de zone boven gemiddeld hoogwater bij springtij (HW85).
Het hoog supralitoraal is de zone die hoger ligt dan de functionele schorren.
Dze zone overspoelt niet bij elk springtij maar enkel bij extreme hoogwaters zoals bij stormtij of hoge bovenafvoer.
Dat is onvoldoende om estuariene schorvegetaties te ontwikkelen.
Dit zijn dus de overgangszones tussen het schor en de dijkvegetatie, alsook opgehoogde delen midden in het schor.
De ondergrens van het hoog supralitoraal, tevens de bovengrens van het schor, ligt op 6,4m TAW van de Belgisch-Nederlandse grens tot de Roggeman en Vlassenbroek.
Stroomopwaarts Roggeman/Vlassenbroek en in de Durme en Rupel wordt 6,2m TAW aangehouden als ondergrens.
In de Ringvaart en Tijarm Zwijnaarde ligt de ondergrens op 5.75m TAW.

### Ecotopenkaart

De geomorfologische kaart en de fysiotopenkaart worden samengevoegd om de ecotopen te bekomen (Tabel \@ref(tab:030-tabel-klassen-E1)).

In de **sublitorale zone** zijn de ecotopen gelijk aan de fysiotopen, maar het "Zeer diep subtidaal" en "Diep subtidaal" worden samengenomen in het ecotoop "Diep subtidaal".

In de **litorale zone** worden de slikfysiotopen gecombineerd met de geomorfologie tot zachte slikken, natuurlijk harde slikken, of antropogene harde slikken (Tabel \@ref(tab:030-tabel-klassen-E1)).

In het *ecotopenstelsel 2.0* wordt in de litorale zone tevens rekening gehouden met de hellingsgraad in de zachte slikzones om zachte slikken met een steile helling (\>25%) aan te duiden.
...
-   Hoog supralitoraal: Met hogere planten begroeide zone boven de functionele schorren;
...
caption_tab <- str_c("Oppervlaktes en oppervlaktepercentages van ecotopen in de Beneden-Zeeschelde in de laatste 6 jaar voor ", laatste_jaar, ", inclusief het startjaar ", vroegste_jaar, ".")
