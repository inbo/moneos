...
In het **litoraal** is het zacht substraat in totaal ook met 0,7 hectare toegenomen sinds `r laatste_jaar - 1` Dit komt door een grote toename in het middelhoog slik, aangezien zowel het laag slik als het hoog slik zijn afgenomen in oppervlakte.
...
Ook in het natuurlijk hard substraat is het litoraal veel gestegen sinds `r vroegste_jaar`, namelijk 14 hectare (een stijging van bijna 80% van de initiële oppervlakte).
...
De herinrichting is momenteel afgerond en de kaart weerspiegelt nu de nieuwe situatie (*sub-kaart toevoegen?*).
De oppervlakte schor is met 18 hectare toegenomen ten opzichte van het voorgaande jaar.
Voor een gedeelte is deze schortoename zichtbaar in de GGG Burchtse Weel, waarbij grote delen potentiële pionierzone inmiddels begroeid zijn (*kaartje*).
...
Het hoog supralitoraal wat met breuksteen bedekt is (hard antropogeen) is juist toegenomen met bijna 4 hectare.
In totaal is het antropogeen hard substraat (de breuksteenzones zowel in het litoraal als supralitoraal) toegenomen met bijna 5 hectare sinds het voorgaande jaar.

De totale oppervlakte van de Beneden-Zeeschelde ecotopen is met 5,3 ha gestegen.

\-\-\-- nog te checken / aanpassen -----
...
Een toename in estuarien gebied (gereflecteerd in meer potentiële pionierzone) door gewijzigde waterstanden is bijvoorbeeld het geval in het Bazels GGG.).
...
Wat de korte termijn evolutie betreft (= verschil tussen `r laatste_jaar` en `r laatste_jaar -1`), is er binnen de 'enge' planimetrie een afname in laag slik zacht substraat die wat kleiner is dan de afname in de volledige planimetrie.
Hetzelfde geldt voor de afname in hoog slik zacht substraat.
Het middelhoog slik zacht substraat is ook binnen de 'enge' planimetrie gestegen, maar minder dan in het volledige gebied.
Ongeveer de helft van deze toename heeft dus plaatsgevonden binnen de laterale uitbreidingen.
...
Hetzelfde geldt voor de toename aan schor, welke grotendeels plaatsvond binnen de uitgebreide gebieden.
De afname van het hoog supralitoraal vond bijna volledig plaats binnen de 'enge' planimetrie.
De toename van antropogeen hard substraat gebeurde ook gedeeltelijk in de laterale uitbreidingen.
