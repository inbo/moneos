...
figuur_kaart_ff <- "Ecotopenkaart Zeeschelde 1.0 2021 Burchtse Weel schoruitbreiding (centraal onder), overzichtskaart met rode kader als indicator detailkaart (linksboven), ecotopenkaart 2020 Burchtse Weel (rechtsboven). Zie Figuur \@ref(fig:030-figuur-kaart-bez) voor legende"
