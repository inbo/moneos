...
Een overzicht van de ingemeten vaste MONEOS raaien wordt gegeven in Tabel \@ref(tab:130-tabel-overzicht-raaien) in Bijlage \@ref(BL1).
...
Vanaf eind 2012 is een RTK-DGPS_Trimble R8 gebruikt, waarbij zowel GPS- en GLONASS-satellietsignalen ontvangen kunnen worden.
<!--# nu nog een nieuwe TRIMBLE? --> De ingestelde maximale foutenmarge om een meting te kunnen uitvoeren is 2 cm op de z-waarde maar ligt gemiddeld rond ±1 cm.
...
Door schoruitbreiding of -erosie kan het startpunt van de raai alsook het lokale laagwater verschillen tussen de jaren.\
...
Een overzicht van de raaien in de Beneden Zeeschelde wordt gegeven in Bijlage \@ref(BL1) Figuur \@ref(fig:130-figuur-raaien-BEZ).
...
cap_raaien_vast <- "Overzicht vaste MONEOS raaien langs de Zeeschelde en zijrivieren. Raaicode, X,Y coördinaat (Lambert 72), naam,  saliniteitszone, OMES zone, afstand tot de Belgisch-Nederlandse grens en rivier."
