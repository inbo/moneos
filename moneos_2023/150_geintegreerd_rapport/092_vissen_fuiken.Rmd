...
In de zone met sterke saliniteitsgradiënt (Doel en Antwerpen) werden er meer soorten gevangen dan in de oligohaliene (Steendorp) en zoetwater (Branst) zone (Tabel \@ref(tab:092-tabel-aantal-soorten)).
Over de beschouwde periode worden er inderdaad systematisch meer soorten gevangen in deze zone en neemt het aantal soorten af naar de oligohaliene en zoete zone (Figuur \@ref(fig:092-figuur-aantal-soorten-locatie-historisch)).
Het totaal aantal soorten jaarlijks gevangen in de Zeeschelde in de periode 2012-`r laatste_jaar` varieert rond de 40 (Figuur \@ref(fig:092-figuur-aantal-soorten-historisch)).
...
tabel_gevangen_soorten  %>% 
  ...
  knitr::kable(booktabs = TRUE,
               ...
               align = c("l", rep("c", 12)),
               col.names = c("", rep(c("Antw.", "Appels", "Kastel", "Overb.", "Paard.", "Steend."), 3)),
               escape = FALSE) %>%
...
```{r 092-figuur-aantal-soorten-historisch, fig.cap=cap_aantal_soorten, out.width="90%"}
...
Uit deze analyse blijkt dat de relatieve soortenabundantie zowel seizoenaal als ruimtelijk verschilt (Figuur \@ref(fig:092-figuur-relatief-aantal)).
...
Uitgedrukt in biomassa overheerst de spiering ook in het voorjaar in Antwerpen en Steendorp (Figuur \@ref(fig:092-figuur-relatieve-biomassa)).
