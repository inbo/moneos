...
```{r 080-080-figuur-densiteit-totaal-gebied-maandverloop-jaren}
...
```{r 080-080-figuur-densiteit-totaal-ZS-maandverloop-jaren}
ylb <- expression(paste("densiteit ", "(ind/", '40', m^3, ")"))
...
```{r 080-080-figuur-biomassa-totaal-ZS-maandverloop-jaren}
...
```{r 080-080-figuur-biomassa-gebied-maandverloop-jaar}
...
```{r 080-080-figuur-biomassa-biomassa-perc-soorten-perjaar}
...
```{r 080-080-figuur-soortenrijkdomZS-perjaar}
...
```{r 080-080-figuur-soortenrijkdomZS-perjaargebied}
#In jaar 2013 niet volledig gesampled wat taxa rijkdom beinvloedt, dus die niet
#met exoten
...
```{r 080-080-figuur-Shannon-diversiteit}
...
```{r 080-070-figuur-soortenrijkdom-ZeescheldeIV}
...
```{r 080-070-oppervlakte koppelen}
