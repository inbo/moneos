...
tabel_aantal_soorten <-
  ...
  summarise(soorten = as.character(n())) %>% 
  ungroup() %>% 
  pivot_wider(locatie, names_from = seizoen, values_from = soorten, values_fill = "")
...
ggsave(paste0(pad_figuren, "diversiteit_N_D_EMSE_diadroom.jpg"), width = 7, height = 5)
...
ggsave(paste0(pad_figuren, "diversiteit_N_D_EMSE_zoet.jpg"), width = 7, height = 5)
...
ggsave(paste0(pad_figuren, "aantallen_sleutelsoorten_EMSE_marien.jpg"), width = 9, height = 5)
...
ggsave(paste0(pad_figuren, "aantallen_sleutelsoorten_EMSE_diadroom.jpg"), width = 9, height = 4)
...
ggsave(paste0(pad_figuren, "aantallen_sleutelsoorten_EMSE_zoet.jpg"), width = 9, height = 5)
