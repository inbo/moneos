...
ggsave(paste0(pad_figuren, "diversiteit_N_D_EMSE_marien.jpg"), width = 7, height = 6)
...
ggsave(paste0(pad_figuren, "diversiteit_N_D_EMSE_diadr.jpg"), width = 8, height = 6)
...
ggsave(paste0(pad_figuren, "diversiteit_N_D_EMSE_zoet.jpg"), width = 8, height = 6)
...
relatieve_aantallen_EMSE <- 
  ...
  mutate(max_aantal = relatief_aantal >= 0.1,
         max_gewicht = relatief_gewicht >= 0.1) %>%
  ungroup() %>% 
  group_by(soort) %>% 
...
ggsave(paste0(pad_figuren, "relatieve_aantallen_tot_aantal_EMSE_marien.jpg"), width = 11, height = 7, bg = "white")
...
ggsave(paste0(pad_figuren, "relatieve_aantallen_tot_aantal_EMSE_diadroom.jpg"), width = 11, height = 7, bg = "white")
...
ggsave(paste0(pad_figuren, "relatieve_aantallen_tot_aantal_EMSE_zoet.jpg"), width = 11, height = 7, bg = "white")
...
ggsave(paste0(pad_figuren, "relatieve_biomassa_tot_biomassa_EMSE_marien.jpg"), width = 11, height = 7, bg = "white")
...
ggsave(paste0(pad_figuren, "relatieve_biomassa_tot_biomassa_EMSE_diadroom.jpg"), width = 11, height = 7, bg = "white")
...
ggsave(paste0(pad_figuren, "relatieve_biomassa_tot_biomassa_EMSE_zoet.jpg"), width = 11, height = 7, bg = "white")
...
ggsave(paste0(pad_figuren, "aantallen_sleutelsoorten_EMSE_marien.jpg"), width = 10, height = 6)
...
ggsave(paste0(pad_figuren, "aantallen_sleutelsoorten_EMSE_diadroom.jpg"), width = 11, height = 6)
...
ggsave(paste0(pad_figuren, "aantallen_sleutelsoorten_EMSE_zoet.jpg"), width = 10, height = 6)
