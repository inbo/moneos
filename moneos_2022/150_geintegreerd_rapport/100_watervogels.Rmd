...
Aantalsveranderingen kunnen zowel door factoren van buiten (bijvoorbeeld klimaatverandering, Europese populatietrends,...) als van binnen het estuarium gestuurd worden.
Dit betekent dat trends steeds in een ruimer kader en met de nodige omzichtigheid geëvalueerd moeten worden.
Interne factoren kunnen bijvoorbeeld een gewijzigd voedselaanbod, foerageerareaal of een gewijzigde verstoringsinvloed zijn.

De eerstelijnsrapportage beschrijft de aangeleverde watervogeldata van de Zeeschelde, de zijrivieren en de estuariene sigmagebieden met een focus op de verzamelde tellingen tot de winter van `r as.numeric(laatste_jaar) - 1` (eindigend in maart `r laatste_jaar`).
De data werden gefilterd uit de Watervogeldatabank van het INBO.
...
Sinds oktober 1991 tellen medewerkers van het INBO maandelijks het aantal watervogels langs de Zeeschelde vanaf de Belgisch-Nederlandse grens tot Gent.
De trajecten op Nederlands grondgebied werden niet opgenomen.
De aangeleverde data lopen van oktober 1991 tot en met maart `r laatste_jaar`.
Oorspronkelijk werd enkel tijdens de winter (oktober -- maart) geteld, vanaf 1993 wordt ook tijdens de zomer geteld.
Deze zomertellingen (april (behalve juni) - september) werden stopgezet tussen Antwerpen en Gent sinds het telseizoen 2018/19.
In de zomer wordt enkel nog gebiedsdekkend geteld in juni.
Sinds de winter van 1995/1996 wordt ook geteld langsheen de Rupel (Rupelmonding -- sas van Wintam).
De tellingen gebeuren vanaf een boot en bij laag tij.
Omdat het niet haalbaar is om het volledige onderzoeksgebied grondig te tellen tijdens de periode van één laag tij, worden de telling gespreid over drie dagen.
De dagen worden steeds gegroepeerd in het midden van de maand.
Alle watervogelsoorten (en steltlopers) worden tijdens de boottellingen geteld sinds het begin van de tellingen, de meeuwen en sternen worden geteld sinds oktober 1999.
De tellingen langsheen de zijrivieren (behalve het deel tussen de Rupelmonding tot Wintam) en van de sigmagebieden worden uitgevoerd vanop de rivieroever door vrijwilligers of in het geval van sigmagebieden soms door medewerkers van het INBO.
De meeuwen, sternen, wulp, kievit en waterhoen worden langs de zijrivieren geteld sinds oktober 1999.
In de exploratieve analyse werden de meeuwen en sternen uit de dataset gelaten.

**Ruimtelijke en temporele afbakening data**

*Boottellingen*

De data omvatten de aantallen watervogels op de Zeeschelde, geteld vanop de boot.
Dit is inclusief deze op het traject Melle-Gentbrugge dat geteld wordt vanaf de dijk (in de databank als traject Tijgebonden oude Schelde Gent - tot aan monding Ringvaart (2050810)) en deze op het gedeelte van de Rupel dat vanop de boot wordt geteld.
Om de data voor het waterlichaam ZSIII+Rupel compleet te maken wordt de dataset aangevuld met tellingen van de Rupel die zijn geteld vanaf de dijk.
De zone oligohalien omvat de boottellingen op de Zeeschelde zonder de tellingen op de Rupel.
De dijktellingen gaan enkel door in de winter.
De teltrajecten (9999999 en 9999998) gelegen op Nederlands grondgebied werden niet in rekening gebracht voor de data analyse.
...
Voor de Getijdenetes zijn geen afzonderlijke riviertellingen beschikbaar; voor de Getijdedijle is een beperkte dataset beschikbaar (1996, 1999 en verder vanaf 2008).
Eén teltraject in de Durme (Durmemonding tot Mirabrug) werd niet geteld in 2007-2008.

*Sigmagebieden*

De geselecteerde sigmagebieden betreffen de estuariene gebieden (GGG's en ontpolderingen) gerealiseerd in het kader van het geäctualiseerde Sigmaplan.
Deze worden weergegeven in Tabel\@ref(tab:100-tabel-estuarienesigmagebieden).
...
Zenne ZEMST(brug Brusselse Steenweg) - HOMBEEK (Eglegemvijver) : geen telling in februari 2022 Tijgebonden Oude Schelde Gent - monding Ringvaart- ontbrekende telling november 2021 en maart 2022.
Groot Buitenschoor (Schelde Containerkaai - grens) (RO) - ontbrekende telling in januari en maart 2022.
...
De exploratieve data-analyse van de overwinterende (niet-broedvogels) van de Zeeschelde en zijn zijrivieren is afgestemd met de vernieuwde evaluatiemethodiek (EMSE, 2021).
Een aantal aanpassingen werden in deze rapportage gedaan:
...
Deze categorie werd niet weerhouden.
...
De doelen zijn berekend op basis van de overwinterende vogelsoorten in de estuariene gebieden van de Zeeschelde en zijrivieren (Rupel, Durme, Dijle, Zenne - voor de Netes zijn geen tellingen beperkt tot de estuariene habitats).
...
*Indexen*: Om de trends te bespreken is er een index berekend met 2009 als referentiejaar en gebaseerd om de maximale winteraantallen.
...
Tussen 2008 en 2010 was er een klein herstel maar sinds 2012 zijn de vogelaantallen verder afnemend tot stabiel (Figuur \@ref(fig:100-figuur-index-niveau3)).
...
Vanaf 2010/11 is het proportioneel aandeel van elke zone relatief stabiel (Figuur \@ref(fig:100-figuur-verhouding-aantallen)).
...
In de zone met sterke **Saliniteitsgradient** (Kennedytunnel -- Grens) vertonen de winteraantallen tussen 1999 en 2007 een dalende trend.
In de periode 2008-2013 lijken de aantallen zich te stabiliseren.
Sinds 2013 zijn de vogelaantallen afnemend, gedurende winterseizoen `r laatste_telseizoen` stabiliseerde de toestand.
Tegnenover het beschouwde referentiejaar 2009 is er een afname met meer dan de helft van de maximale vogelaantallen.
...
In **Zoet lang verblijf** (Dendermonde -- Durmemonding) is na de sterk dalende trend tussen 2001/02 en 2006/07.
Tussen 2006/07 en 2015/16 zijn de aantallen relatief stabiel tot zwak dalend.
Net zoals in Zeeschelde I was er ook een terugval in de aantallen in de winter van 2017/18.
De aantallen blijven ook de laatste seizoenen afnemen.
...
In **Zoet kort verblijf** (Gentbrugge -- Dendermonde) was er een duidelijke terugval in het overwinterend aantal watervogels in de winter van 2017/18.
...
De laatste twee telseizoenen liggen de aantallen (maximaal en gemiddelde) opnieuw iets hoger maar slechts schommeld rond een index van 0.3 tenopzichte van 2009.
...
Bovendien is er een datahiaat in de winter van 2007-2008.
...
Mogelijk is dat te linken aan de frequentie van grote overstortdebieten van ongezuiverd afvalwater.
...
Winter `r laatste_telseizoen` is er voor het derde jaar op rij een stijging in het aantal benthivore overwinteraars (voornamelijk steltlopers) in zone met sterke saliniteitsgradiënt.
Dit is te wijten aan de hogere aantallen wulp en vooral scholekster (Figuur \@ref(fig:100-figuur-aantallen-steltlopers)).
In zone zoet lang en oligohalien werden meer kieviten geteld de laatste jaren.
Deze soorten boren een nieuwe voedselbron aan - schelpdieren - op de lage slikzone.
XXXXXXXXXX voedselaanbod (Figuur \@ref(fig:070-figuurxx)).
...
Het gemiddeld aantal visetende vogels in Zeeschelde II (vooral aalscholver) varieert met de jaren, vermoedelijk in respons op de beschikbare visbiomassa (XXXX Figuur \@ref(fig:)).
...
In de zone met sterke saliniteitsgradiënt is er een toename in bodemdierbiomassa vastgesteld (Hoofdstuk \@ref(HBd)) (vooral dan *Corophium*, *Hediste* en *Cyathura*).
...
De oppervlakte zacht substraat in de verschillende zones is in beperkte mate veranderd xxxxx(Hoofdstuk \@ref(HEc)) en heeft hierdoor een beperkte invloed, tot nu toe, op de berekende dichtheden.
...
De wintermaxima in de estuariene sigmagebieden (Tabel\@ref(tab:100-tabel-estuarienesigmagebieden)) vertonen een duidelijke sprong vanaf het moment de inrichting voltooid is (zie Tabel xxxxx inleiding met timing van de natuurontwikkelingsgebieden) (Figuur \@ref(fig:100-figuur-wintermaxima-sigma-estuarien)).
De wintermaxima in de estuariene sigmagebieden vertoonden een maximum in 2017, dit was vooral het gevolg van de grote vogelaantallen in het GGG Zennegat (Figuur \@ref(fig:100-figuur-wintermaxima-sigmagebieden-estuarien)).
De nieuwe gebieden slagen er niet in om het glijdend gemiddelde van de dalende watervogelaantallen op de Zeeschelde om te buigen in stijgende wintermaxima ((Figuur \@ref(fig:100-figuur-natuurindicator-zeescheldesigma-estuarien)).
...
Over de periode 2009-2022 bekeken is er op het niveau van de Zeeschelde een dalende trend te zien met de laatste jaren een stabiel laag aantal overwinterende watervogels.
De trendindex toont een gelijkaardig patroon over de verschillende deelzones.
...
De diversiteit is het grootst in de zone met een sterke saliniteitsgradiënt waar ook de laatste 2 jaar een duidelijke toename werd vastgesteld van benthivore steltlopers (scholekster en wulp).
Vooral de toename van de scholekster is het gevolg van een nieuwe voedselbron op de lage slikken (xxxx).
De afname van de vogelaantallen langsheen de Zeeschelde wordt gecompenseerd door de toename van de vogelaantallen.
