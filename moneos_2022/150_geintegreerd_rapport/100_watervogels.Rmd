...
Het betreft alle recent ingerichte sigmagebieden opgenomen in het Meest Wenselijke Alternatief. Zie hoofdstuk 2. De overige gebieden worden in de mate van het mogelijke meegeteld met de boottellingen.
...
Bespreking per deelgebied <!--# tussentitel van maken? --> (Figuur \@ref(fig:100-figuur-index-niveau3)):
...
Het gemiddeld aantal visetende vogels in Zeeschelde II (vooral aalscholver) varieert met de jaren, vermoedelijk in respons op de beschikbare visbiomassa of de zichtbaarheid/turbiditeit (XXXX Figuur \@ref(fig:)).
...
In de zone met sterke saliniteitsgradiënt is er een toename in bodemdierbiomassa vastgesteld (Hoofdstuk \@ref(HBd)).
...
De wintermaxima in de estuariene sigmagebieden (Tabel\@ref(tab:100-tabel-estuarienesigmagebieden)) vertonen een duidelijke sprong vanaf het moment de inrichting voltooid is (zie Tabel\@ref(tab:xxinleidingx)) (Figuur \@ref(fig:100-figuur-wintermaxima-sigma-estuarien)).
...
De afname van de vogelaantallen langsheen de Zeeschelde wordt gecompenseerd door de toename van de vogelaantallen in de estuariene natuurontwikkelingsgebieden. Dit resulteert tot op heden niet in een totale toename van de watervogelaantallen binnen het estuarium.
...
tabel_trofischegroep <- 
  read_delim(paste0(pad_tabellen, "Voedselgilde_exoten_Moneosrapport.csv"),
              delim = ";")
