...
Minstens de scholekster lijkt een nieuwe voedselbron aan te boren - schelpdieren - op de lage slikzone.(Figuur \@ref(fig:070-figuur13)).
...
De wintermaxima in de estuariene sigmagebieden (Tabel\@ref(tab:100-tabel-estuarienesigmagebieden)) vertonen een duidelijke sprong vanaf het moment de inrichting voltooid is (zie Tabel \@ref(tab:020-tabel-natuurontwikkelingsprojecten) (Figuur \@ref(fig:100-figuur-wintermaxima-sigma-estuarien)).
