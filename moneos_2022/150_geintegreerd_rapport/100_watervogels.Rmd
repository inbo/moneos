...
cap_verhouding_abundante_soorten <- "Verhouding van de dominante soorten (> 5% totaal) per zone sinds 2009."
...
knitr::include_graphics(paste0(pad_figuren, "100_figuur_ShannonDiversity_metmeeuwen.jpg"))
...
cap_aantallen_viseters <- "Trends in het gemiddeld aantal getelde wintervogels (okt.-mrt.) voor 2 abundante visetende (piscivore) en twee abundante steltlopers in de 4 KRW-zones van de Zeeschelde+Rupel."
...
```{r 100-figuur-wintermaxima-sigmagebieden-estuarien, fig.cap=cap_wintermaxima_sigmagebieden,out.width="80%"}
...
```{r 100-figuur-natuurindicator-zeescheldesigma-estuarien, fig.cap=cap_natuurindicator_sigma,out.width="80%"}
