...
Sindsdien duiken er steeds meer waarnemingslocaties op en plant de soort zich over het volledige estuarien valleigebied voort.\
...
Ruwe trendinschattingen zijn met het nodige voorbehoud eventueel wel zinvol (Herremans et al. 2018).\
...
# hoofding tabel
caption_x_waarden <- "Totaal aantal waarnemingen in de vallei van de Zeeschelde en haar zijrivieren (inclusief niet gevalideerde waarnemingen). "
...
In het stroomgebied van de Grote Nete blijft de soort beperkt tot de vallei van de Grote Laak.
...
In 2020 waren er (`r nrow(zoogdier_data[which(zoogdier_data$naam_nl == "Europese Otter" & year(zoogdier_data$datum) == 2020 & str_detect(zoogdier_data$status, "Goed")),])` gevalideerde waarnemingen en in 2021 `r nrow(zoogdier_data[which(zoogdier_data$naam_nl == "Europese Otter" & year(zoogdier_data$datum) == 2021 & str_detect(zoogdier_data$status, "Goed")),])`.
...
<!--# Er is op de brantse plaat wel eens een jong geboren een jaar of 10 geleden -->\
<br/>
...
Slechts vier exemplaren werden stroomopwaarts Antwerpen gespot.
...
In dat zelfde jaar werden bevers waargenomen in 64 km-hokken, m.a.w. een verhouding van `r round(64/29, 2)` km-hokken per territoria.
