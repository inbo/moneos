...
# lijst met telgebieden aangemaakt met een aantal kenmerken
...
```{r inlezendata Midmaanalyseset voor berekening natuurindicator, include=FALSE}
...
# Uit deze dataset halen we de aantallen voor de zijrivieren en de Sigmaprojectgebieden
# De query is uitgecommentarieerd omdat die van thuis uit redelijk wat tijd vergt. In plaats daarvan gebruiken we de csv gebaseerd op een recente bevraging van de Warehouse
...
Waterbirds <- read_csv("data-output/Waterbirds.csv")
# Correctie dubbels
...
WaterbirdsBT %>% 
  ...
  dplyr::select(-c(taxongroepcode,gebiedsgroep_code, wetnaam, teldatum)) %>% 
