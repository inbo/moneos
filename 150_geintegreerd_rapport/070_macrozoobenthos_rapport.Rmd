...
```{r 070-figuur1-soorten, fig.cap=caption_regressie1, out.width="100%",fig.pos="H"}
...
```
<br/>
```{r 070-figuur2-soorten, fig.cap=caption_regressie2, out.width="100%",fig.pos="H"}
...
```
<br/>
```{r 070-figuur3-soorten, fig.cap=caption_regressie3, out.width="100%",fig.pos="H"}
...
caption_regressie7 <- "De relatie tussen subtidale soortenrijkdom en aantal onderzochte Oligochaeta na rarefactie voor de verschillende KRW zones in de Zeeschelde voor 2014 en 2017."
...
caption_regressie8 <- "De relatie tussen subtidale soortenrijkdom en aantal onderzochte Oligochaeta na rarefactie voor de verschillende zijrivieren voor 2014 en 2017."
...
```{r 070-figuur10-soorten, fig.cap=caption_regressie10, out.width="100%", fig.pos="H"}
...
```
<br/>
```{r 070-figuur11-soorten, fig.cap=caption_regressie11, out.width="100%", fig.pos="H"}
...
```
<br/>
```{r 070-figuur12-soorten, fig.cap=caption_regressie12, out.width="70%", fig.pos="H"}
...
```{r 070-figuur13, fig.cap=caption_regressie13, out.width="70%", fig.pos="H"}
caption_regressie13 <- "Gemiddelde van de intertidale systeembiomassa (gram asvrij drooggewicht per m²) gewogen over de fysiotoopoppervlakte per waterlichaam."

knitr::include_graphics(paste0(pad_figuren, "070-figuur-gewogengembiomassa.jpg"))
```
<br/>
```{r 070-figuur14, fig.cap=caption_regressie14, out.width="70%",fig.pos="H"}
