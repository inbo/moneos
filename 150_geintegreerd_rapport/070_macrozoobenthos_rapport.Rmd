...
```{r 070-figuur6-soorten, fig.cap=caption_regressie6}
...
```{r 070-figuur7-soorten, fig.cap=caption_regressie7}
...
```
<br/> 
De soortenrijkdom in het subtidaal van de zijrivieren staat weergegeven in Figuur \@ref(fig:070-figuur8-soorten). Het patroon is heel erg vergelijkbaar met dat voor het intertidaal: de Zenne is de soortenrijkste rivier, daarna volgen Dijle en Nete en Durme en Rupel hebben de laagste diversiteit. 

```{r 070-figuur8-soorten, fig.cap=caption_regressie8}
...
```{r 070-figuur4-soorten, fig.cap=caption_regressie4}
...
Interessant is ook om te kijken naar verschillen in de Oligochaeta gemeenschap tussen intertidalal en subtidaal. In de Zeeschelde 
