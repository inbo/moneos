...
| \arrayrulecolor{white} ![](`r paste0(pad_tabellen, "030_tabel_1_tabel_klassen.png")`){out.width="100%"} |
| -- |
...
| \arrayrulecolor{white} ![](`r paste0(pad_tabellen, "030_tabel_2_Oppervlakte2010_2019.PNG")`){out.width="100%"} |
| -- |
...
| \arrayrulecolor{white} ![](`r paste0(pad_tabellen, "030_tabel_3_evolutie.PNG")`){out.width="100%"} |
| -- |
