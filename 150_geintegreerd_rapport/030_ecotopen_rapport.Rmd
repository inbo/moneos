...
```{r 030-tabel-1-tabel-klassen, out.width="100%"}

caption_tabel_klassen <- "Fysiotoopklassen en geomorftypes worden gecombineerd tot ecotopenklassen."

img <- str_c("![](", pad_tabellen, "030_tabel_1_tabel_klassen.png", ")")
temp.df = data.frame(image = img)

temp.df %>%
  knitr::kable(format = "pandoc",
               caption = caption_tabel_klassen,
               booktabs = TRUE,
               col.names = NULL)
...
```{r 030-tabel-2-tabel-oppervlakte20102019, out.width="100%"}

caption_tabel_opp <- "Oppervlaktes en oppevlaktepercentages van ecotopen in de Beneden-Zeeschelde tussen 2010 en 2019."

img <- str_c("![](", pad_tabellen, "030_tabel_2_Oppervlakte2010_2019.png", ")")
temp.df = data.frame(image = img)

temp.df %>%
  knitr::kable(format = "pandoc",
               caption = caption_tabel_opp,
               booktabs = TRUE,
               col.names = NULL)
...
```{r 030-tabel-3-tabel-evolutie, out.width="100%"}

caption_tabel_opp_evolutie <- "Lange- en korte termijnevolutie in de Beneden-Zeeschelde tussen 2010 en 2019."

img <- str_c("![](", pad_tabellen, "030_tabel_3_evolutie", ")")
temp.df = data.frame(image = img)

temp.df %>%
  knitr::kable(format = "pandoc",
               caption = caption_tabel_opp_evolutie,
               booktabs = TRUE,
               col.names = NULL)
