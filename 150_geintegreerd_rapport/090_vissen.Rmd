...
![(#fig:Figuur1-1) De met ankerkuil bemonsterde locaties in het Zeeschelde estuarium sinds 2012.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image1.png){width="5.905555555555556in" height="4.039238845144357in"}
...
![(#fig:Figuur1-2) Het getijdengebied van het Zeeschelde-estuarium met aanduiding van de vismeetstations die met fuiken worden bemonsterd.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image2.png){width="5.14926290463692in" height="3.640883639545057in"}
...
![(#fig:Figuur1-3) Locaties van het vrijwilligersmeetnet op de Zeeschelde en de Rupel (2019).](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image3.png){width="5.905555555555556in" height="4.17957239720035in"}
...
![(#fig:Figuur1-4) Totaal aantal gevangen soorten per seizoen en per vangstcampagne (2012-2019), en het totaal aantal gevangen soorten per vangstcampagne in de Zeeschelde.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image4.png){width="5.455593832020997in" height="2.7513812335958003in"}
...
![(#fig:Figuur1-5) Gemiddeld aantal individuen per m³ water gevangen in de Zeeschelde in de periode 2012-2019.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image5.png){width="5.905555555555556in" height="4.105064523184602in"}
...
![(#fig:Figuur1-7) Het relatief aantal gevangen individuen in de Zeeschelde tijdens de ankerkuilcampagnes in het voorjaar (VJ), de zomer (Z) en het najaar (NJ) van 2019. Boven elke grafiek staat naast de locatie tussen haakjes het aantal gevangen vissen.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image7.png){width="5.713888888888889in" height="5.106944444444444in"}

![(#fig:Figuur1-8) De relatieve biomassa van de vangsten in de Zeeschelde tijdens de ankerkuilcampagnes in het voorjaar (VJ), de zomer (Z) en het najaar (NJ) van 2019. Boven elke grafiek staat naast de locatie tussen haakjes het totaal gewicht.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image8.png){width="5.905555555555556in" height="5.289746281714786in"}
...
![(#fig:Figuur1-9) Het aantal (links) en percentage (rechts) rekruterende soorten per locatie in de Zeeschelde op basis van ankerkuilvangsten (2012-2019).](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image9.png){width="5.905555555555556in" height="1.2376038932633422in"}
...
![(#tab:Tabel1-1). *Rekruterende en opgroeiende soorten in de Zeeschelde.*](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image10.png){width="4.071992563429571in" height="8.607735126859142in"}
...
![(#fig:Figuur1-10) Het percentage rekruterende soorten per locatie in de Zeeschelde op basis van ankerkuilvangsten (2012-2019).](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image11.png){width="3.9604166666666667in" height="2.379861111111111in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image12.png){width="3.342361111111111in" height="1.8069444444444445in"}

Tabel \@ref(tab:Tabel1-3). *Relatieve percentages exoten met ankerkuil gevangen op vier locaties in de Zeeschelde (2012-2019).*

![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image13.png){width="3.342361111111111in" height="1.8069444444444445in"}
...
![(#fig:Figuur1-11) Aantal vissoorten gevangen per seizoen op zes locaties in de Zeeschelde in 2019. VJ: voorjaar, Z: zomer en NJ: najaar.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image14.png){width="5.820833333333334in" height="3.8534722222222224in"}

![(#fig:Figuur1-12) Aantal vissoorten gevangen per jaar op zes locaties in de Zeeschelde in de periode 2009-2019.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image15.png){width="5.905555555555556in" height="2.9942847769028873in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image18.png){width="5.510416666666667in" height="2.40625in"}
...
![(#fig:Figuur1-16) Het percentage rekruterende soorten per locatie in de Zeeschelde op basis van fuikvisserij (2009-2019).](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image19.png){width="5.784339457567804in" height="3.1041666666666665in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image20.png){width="4.420138888888889in" height="6.8069444444444445in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image21.png){width="5.905555555555556in" height="1.1198753280839895in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image22.png){width="5.905555555555556in" height="1.1198753280839895in"}
...
![(#fig:Figuur1-17) Relatieve aantallen bot gevangen met schietfuiken op zes locaties in de Zeeschelde in de periode 2009-2019.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image23.png){width="5.905555555555556in" height="2.604807524059493in"}
...
![(#fig:Figuur1-18) Relatieve aantallen paling gevangen met schietfuiken op zes locaties in de Zeeschelde in de periode 2009-2019.](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image24.png){width="5.905555555555556in" height="2.613455818022747in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image25.png){width="5.905555555555556in" height="2.6538549868766403in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image26.png){width="5.905555555555556in" height="3.616111111111111in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image27.png){width="5.434027777777778in" height="2.060416666666667in"}
...
![](..\090_vissen\templates\figuren_geintegreerd-rapport\media\image28.png){width="5.905555555555556in" height="1.8539490376202974in"}
