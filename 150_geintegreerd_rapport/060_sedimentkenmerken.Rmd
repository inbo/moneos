...
__Gunther Van Ryckegem, Joram De Beukelaer & Frank Van de Meutter__


## Inleiding

Op elke locatie waar monsters voor het macrozoöbenthos worden genomen (zie Hoofdstuk XXX), wordt een begeleidend sedimentstaal genomen. Van deze stalen worden de granulometrische karakteristieken bepaald door laserdiffractie (LDIF) en wordt het gehalte aan organisch materiaal (OM%) bepaald door verassing (LOI). 
