...
“DataMONEOSWatervogels-Zeeschelde_zijrivieren_totwinter**XXX**.xlsx”
...
Eerste telseizoen zonder zomertellingen (behalve juni) tussen Antwerpen en Gent.
...
INBO Zeeschelde tellingen zijn volledig uitgevoerd zoals gepland.
...
INBO Zeeschelde tellingen zijn volledig uitgevoerd zoals gepland behalve in april 2020 kon de telling in Zeeschelde IV niet doorgaan door coronamaatregelen.
...
De vogelaantallen op de Zeeschelde zijn stabiel of vertonen een doorgaande dalende trend. Deze trends lijken ondertussen al niet meer gerelateerd aan de systeemshift die er kwam door de verbeterende waterkwaliteit. Deze trend vraagt om vergelijking met de trends in de vallei en met de nieuwe gebieden.  
